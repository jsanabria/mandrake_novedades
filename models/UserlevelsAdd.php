...
class UserlevelsAdd extends Userlevels
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->tipo_acceso->CurrentValue = null;
        $this->tipo_acceso->OldValue = $this->tipo_acceso->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['tipo_acceso'] = $this->tipo_acceso->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tipo_acceso
        $this->tipo_acceso->setDbValueDef($rsnew, $this->tipo_acceso->CurrentValue, null, false);
