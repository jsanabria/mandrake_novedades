 ...
 * Page class
 */
class Abono2Add extends Abono2
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("Abono2List"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "Abono2List") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "Abono2View") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("recarga2", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            if (in_array("recarga2", $detailTblVar) && $detailPage->DetailAdd) {
                ...
                $Security->loadCurrentUserLevel($this->ProjectID . "recarga2"); // Load user level of detail table
