		  	...
		  	if($tipo_pago != "") {
				...
				<tr>
					...
					<td class="col-sm-2">
					  <?php 
					  	if($tipo_pago == "RC") {
						  	$sql = "SELECT valor1 FROM parametro WHERE codigo = '006' AND valor1 = 'Bs.';"; 
							$rs = mysqli_query($link, $sql);
							$combo = '<select id="moneda" name="moneda" class="form-control">';
					  	} 
					  	else if($tipo_pago == "PC") {
						  	$sql = "SELECT valor1 FROM parametro WHERE codigo = '006' AND valor1 = 'Bs.' OR valor1 = 'USD';"; 
							$rs = mysqli_query($link, $sql);
							$combo = '<select id="moneda" name="moneda" class="form-control">';
