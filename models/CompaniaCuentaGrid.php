...
class CompaniaCuentaGrid extends CompaniaCuenta
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_titular") && $CurrentForm->hasValue("o_titular") && $this->titular->CurrentValue != $this->titular->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_mostrar") && $CurrentForm->hasValue("o_mostrar") && $this->mostrar->CurrentValue != $this->mostrar->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_cuenta") && $CurrentForm->hasValue("o_cuenta") && $this->cuenta->CurrentValue != $this->cuenta->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_pago_electronico") && $CurrentForm->hasValue("o_pago_electronico") && $this->pago_electronico->CurrentValue != $this->pago_electronico->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_activo") && $CurrentForm->hasValue("o_activo") && $this->activo->CurrentValue != $this->activo->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->titular->clearErrorMessage();
        $this->tipo->clearErrorMessage();
        $this->numero->clearErrorMessage();
        $this->mostrar->clearErrorMessage();
        $this->cuenta->clearErrorMessage();
        $this->pago_electronico->clearErrorMessage();
        $this->activo->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->titular->CurrentValue = null;
        $this->titular->OldValue = $this->titular->CurrentValue;
        ...
        $this->mostrar->CurrentValue = "S";
        $this->mostrar->OldValue = $this->mostrar->CurrentValue;
        $this->cuenta->CurrentValue = 0;
        $this->cuenta->OldValue = $this->cuenta->CurrentValue;
        $this->pago_electronico->CurrentValue = "S";
        $this->pago_electronico->OldValue = $this->pago_electronico->CurrentValue;
        $this->activo->CurrentValue = "S";
        $this->activo->OldValue = $this->activo->CurrentValue;
        $this->compania->CurrentValue = 0;
        $this->compania->OldValue = $this->compania->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['titular'] = $this->titular->CurrentValue;
        $row['tipo'] = $this->tipo->CurrentValue;
        $row['numero'] = $this->numero->CurrentValue;
        $row['mostrar'] = $this->mostrar->CurrentValue;
        $row['cuenta'] = $this->cuenta->CurrentValue;
        $row['pago_electronico'] = $this->pago_electronico->CurrentValue;
        $row['activo'] = $this->activo->CurrentValue;
        $row['compania'] = $this->compania->CurrentValue;
        return $row;
    }
    ...
    protected function validateForm()
    {
        ...
        if ($this->pago_electronico->Required) {
            if (!$this->pago_electronico->IsDetailKey && EmptyValue($this->pago_electronico->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // titular
            $this->titular->setDbValueDef($rsnew, $this->titular->CurrentValue, null, $this->titular->ReadOnly);
            ...
            // mostrar
            $this->mostrar->setDbValueDef($rsnew, $this->mostrar->CurrentValue, null, $this->mostrar->ReadOnly);

            // cuenta
            $this->cuenta->setDbValueDef($rsnew, $this->cuenta->CurrentValue, 0, $this->cuenta->ReadOnly);
            ...
            $masterFilter = $this->sqlMasterFilter_compania();
            ...
            if ($validMasterRecord) {
                $rsmaster = Container("compania")->loadRs($masterFilter)->fetch();
    ...
    protected function addRow($rsold = null)
    {
        ...
        $masterFilter = str_replace("@id@", AdjustSql($this->compania->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
        ...
        // titular
        $this->titular->setDbValueDef($rsnew, $this->titular->CurrentValue, null, false);
        ...
        // mostrar
        $this->mostrar->setDbValueDef($rsnew, $this->mostrar->CurrentValue, null, strval($this->mostrar->CurrentValue) == "");

        // cuenta
        $this->cuenta->setDbValueDef($rsnew, $this->cuenta->CurrentValue, 0, strval($this->cuenta->CurrentValue) == "");
