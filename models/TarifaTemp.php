...
class TarifaTemp extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // codigo
        $this->codigo = new DbField('tarifa_temp', 'tarifa_temp', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre
        $this->nombre = new DbField('tarifa_temp', 'tarifa_temp', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 150, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio
        $this->precio = new DbField('tarifa_temp', 'tarifa_temp', 'x_precio', 'precio', '`precio`', '`precio`', 131, 13, -1, false, '`precio`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "TarifaTempView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifaTempEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifaTempAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TarifaTempView";
            case Config("API_ADD_ACTION"):
                return "TarifaTempAdd";
            case Config("API_EDIT_ACTION"):
                return "TarifaTempEdit";
            case Config("API_DELETE_ACTION"):
                return "TarifaTempDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaTempView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifaTempView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifaTempAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TarifaTempAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TarifaTempEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaTempAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifaTempDelete", $this->getUrlParm());
    }
