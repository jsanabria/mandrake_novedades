...
loadjs.ready("head", function () {
    ...
    fcompania_cuentaedit = currentForm = new ew.Form("fcompania_cuentaedit", "edit");
    ...
    fcompania_cuentaedit.addFields([
    ...
    // Validate form
    fcompania_cuentaedit.validate = function () {
    ...
    // Form_CustomValidate
    fcompania_cuentaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcompania_cuentaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fcompania_cuentaedit.lists.banco = <?= $Page->banco->toClientList($Page) ?>;
    fcompania_cuentaedit.lists.tipo = <?= $Page->tipo->toClientList($Page) ?>;
    fcompania_cuentaedit.lists.mostrar = <?= $Page->mostrar->toClientList($Page) ?>;
    fcompania_cuentaedit.lists.cuenta = <?= $Page->cuenta->toClientList($Page) ?>;
    fcompania_cuentaedit.lists.pago_electronico = <?= $Page->pago_electronico->toClientList($Page) ?>;
    fcompania_cuentaedit.lists.activo = <?= $Page->activo->toClientList($Page) ?>;
    loadjs.done("fcompania_cuentaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fcompania_cuentaedit" id="fcompania_cuentaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fcompania_cuentaedit"], function() {
    fcompania_cuentaedit.createAutoSuggest(Object.assign({"id":"x_banco","forceSelect":true}, ew.vars.tables.compania_cuenta.fields.banco.autoSuggestOptions));
});
</script>
