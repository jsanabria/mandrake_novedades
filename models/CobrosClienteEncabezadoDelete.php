 ...
 * Page class
 */
class CobrosClienteEncabezadoDelete extends CobrosClienteEncabezado
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteEncabezadoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CobrosClienteEncabezadoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CobrosClienteEncabezadoList"); // Return to list
                return;
            }
        }
