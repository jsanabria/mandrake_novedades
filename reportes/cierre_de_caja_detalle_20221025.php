...
///////////////////////////////////
		$sql = "SELECT 
				...
				FROM recarga WHERE fecha BETWEEN '$fecha 00:00:00' AND '$fecha 23:59:59' 
...
$sql = "SELECT c.id, a.id,  
		...
		WHERE 
			c.fecha BETWEEN '$fecha 00:00:00' AND '$fecha 23:59:59' 
...
$sql = "SELECT 
		...
		FROM 
			...
			LEFT OUTER JOIN cliente AS d ON d.id = a.cliente 
		WHERE 
			a.fecha BETWEEN '$fecha 00:00:00' AND '$fecha 23:59:59' AND c.estatus = 'PROCESADO' AND tipo_documento = 'TDCNET' 
			AND b.metodo_pago = 'RC' " . str_replace("xy.", "a.", $where) . ";"; 
