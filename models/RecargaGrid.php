...
class RecargaGrid extends Recarga
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // Check referential integrity for master table 'abono'
            $validMasterRecord = true;
            $masterFilter = $this->sqlMasterFilter_abono();
            ...
            if ($validMasterRecord) {
                $rsmaster = Container("abono")->loadRs($masterFilter)->fetch();
                $validMasterRecord = $rsmaster !== false;
            }
            if (!$validMasterRecord) {
                $relatedRecordMsg = str_replace("%t", "abono", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'recarga'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_abono();
