...
loadjs.ready("head", function () {
    ...
    fproveedor_articuloedit = currentForm = new ew.Form("fproveedor_articuloedit", "edit");
    ...
    fproveedor_articuloedit.addFields([
    ...
    // Validate form
    fproveedor_articuloedit.validate = function () {
    ...
    // Form_CustomValidate
    fproveedor_articuloedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fproveedor_articuloedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fproveedor_articuloedit.lists.fabricante = <?= $Page->fabricante->toClientList($Page) ?>;
    fproveedor_articuloedit.lists.articulo = <?= $Page->articulo->toClientList($Page) ?>;
    loadjs.done("fproveedor_articuloedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fproveedor_articuloedit" id="fproveedor_articuloedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
