...
class Recarga extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // nro_recibo
        $this->nro_recibo = new DbField('recarga', 'recarga', 'x_nro_recibo', 'nro_recibo', '`nro_recibo`', '`nro_recibo`', 19, 10, -1, false, '`nro_recibo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cliente
        $this->cliente = new DbField('recarga', 'recarga', 'x_cliente', 'cliente', '`cliente`', '`cliente`', 19, 11, -1, false, '`cliente`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // fecha
        $this->fecha = new DbField('recarga', 'recarga', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 133, 10, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // metodo_pago
        $this->metodo_pago = new DbField('recarga', 'recarga', 'x_metodo_pago', 'metodo_pago', '`metodo_pago`', '`metodo_pago`', 200, 10, -1, false, '`metodo_pago`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // referencia
        $this->referencia = new DbField('recarga', 'recarga', 'x_referencia', 'referencia', '`referencia`', '`referencia`', 200, 20, -1, false, '`referencia`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // reverso
        $this->reverso = new DbField('recarga', 'recarga', 'x_reverso', 'reverso', '`reverso`', '`reverso`', 202, 1, -1, false, '`reverso`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->reverso->Lookup = new Lookup('reverso', 'recarga', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // monto_moneda
        $this->monto_moneda = new DbField('recarga', 'recarga', 'x_monto_moneda', 'monto_moneda', '`monto_moneda`', '`monto_moneda`', 131, 14, -1, false, '`monto_moneda`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // moneda
        $this->moneda = new DbField('recarga', 'recarga', 'x_moneda', 'moneda', '`moneda`', '`moneda`', 200, 6, -1, false, '`moneda`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tasa_moneda
        $this->tasa_moneda = new DbField('recarga', 'recarga', 'x_tasa_moneda', 'tasa_moneda', '`tasa_moneda`', '`tasa_moneda`', 131, 14, -1, false, '`tasa_moneda`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // monto_bs
        $this->monto_bs = new DbField('recarga', 'recarga', 'x_monto_bs', 'monto_bs', '`monto_bs`', '`monto_bs`', 131, 14, -1, false, '`monto_bs`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tasa_usd
        $this->tasa_usd = new DbField('recarga', 'recarga', 'x_tasa_usd', 'tasa_usd', '`tasa_usd`', '`tasa_usd`', 131, 14, -1, false, '`tasa_usd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // monto_usd
        $this->monto_usd = new DbField('recarga', 'recarga', 'x_monto_usd', 'monto_usd', '`monto_usd`', '`monto_usd`', 131, 14, -1, false, '`monto_usd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // saldo
        $this->saldo = new DbField('recarga', 'recarga', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 131, 14, -1, false, '`saldo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nota
        $this->nota = new DbField('recarga', 'recarga', 'x_nota', 'nota', '`nota`', '`nota`', 200, 250, -1, false, '`nota`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        $this->cobro_cliente_reverso = new DbField('recarga', 'recarga', 'x_cobro_cliente_reverso', 'cobro_cliente_reverso', '`cobro_cliente_reverso`', '`cobro_cliente_reverso`', 19, 10, -1, false, '`cobro_cliente_reverso`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // username
        $this->_username = new DbField('recarga', 'recarga', 'x__username', 'username', '`username`', '`username`', 200, 30, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nota_recepcion
        $this->nota_recepcion = new DbField('recarga', 'recarga', 'x_nota_recepcion', 'nota_recepcion', '`nota_recepcion`', '`nota_recepcion`', 19, 10, -1, false, '`nota_recepcion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('recarga', 'recarga', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // abono
        $this->abono = new DbField('recarga', 'recarga', 'x_abono', 'abono', '`abono`', '`abono`', 21, 20, -1, false, '`abono`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    // Master filter
    public function sqlMasterFilter_abono()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_abono()
    {
        return "`abono`=@abono@";
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "RecargaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RecargaAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RecargaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RecargaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RecargaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RecargaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RecargaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecargaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RecargaDelete", $this->getUrlParm());
    }
