<?php namespace PHPMaker2021\mandrake; ?>
<?php
...
loadjs.ready("load", function () {
    // Startup script
    $(document).ready((function(){$("#cia").focus(),$("#username").prop("disabled",!0),$("#password").prop("disabled",!0),$("#btn-submit").prop("disabled",!0),""!=$("#cia").val()&&($("#username").prop("disabled",!1),$("#password").prop("disabled",!1),$("#btn-submit").prop("disabled",!1))})),$("#cia").change((function(){window.location.replace("db_change.php?db="+$("#cia").val())}));
});
</script>
