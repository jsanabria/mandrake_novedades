...
class ClienteList extends Cliente
{
    ...
    public function __construct()
    {
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fclientelistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->refiere->AdvancedSearch->toJson(), ","); // Field refiere
        $filterList = Concat($filterList, $this->puntos_refiere->AdvancedSearch->toJson(), ","); // Field puntos_refiere
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fclientelistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field refiere
        $this->refiere->AdvancedSearch->SearchValue = @$filter["x_refiere"];
        $this->refiere->AdvancedSearch->SearchOperator = @$filter["z_refiere"];
        $this->refiere->AdvancedSearch->SearchCondition = @$filter["v_refiere"];
        $this->refiere->AdvancedSearch->SearchValue2 = @$filter["y_refiere"];
        $this->refiere->AdvancedSearch->SearchOperator2 = @$filter["w_refiere"];
        $this->refiere->AdvancedSearch->save();

        // Field puntos_refiere
        $this->puntos_refiere->AdvancedSearch->SearchValue = @$filter["x_puntos_refiere"];
        $this->puntos_refiere->AdvancedSearch->SearchOperator = @$filter["z_puntos_refiere"];
        $this->puntos_refiere->AdvancedSearch->SearchCondition = @$filter["v_puntos_refiere"];
        $this->puntos_refiere->AdvancedSearch->SearchValue2 = @$filter["y_puntos_refiere"];
        $this->puntos_refiere->AdvancedSearch->SearchOperator2 = @$filter["w_puntos_refiere"];
        $this->puntos_refiere->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->refiere, $default, false); // refiere
        $this->buildSearchSql($where, $this->puntos_refiere, $default, false); // puntos_refiere
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->refiere->AdvancedSearch->save(); // refiere
            $this->puntos_refiere->AdvancedSearch->save(); // puntos_refiere
        }
        return $where;
    }
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->sucursal, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->contacto, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->ciudad, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->direccion, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->telefono1, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->telefono2, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->email1, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->email2, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->codigo_ims, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->web, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->tipo_cliente, $arKeywords, $type);
        return $where;
    }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->refiere->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->puntos_refiere->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->refiere->AdvancedSearch->unsetSession();
                $this->puntos_refiere->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->refiere->AdvancedSearch->load();
                $this->puntos_refiere->AdvancedSearch->load();
    }
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->refiere->setSort("");
                $this->puntos_refiere->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'adjunto')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("AdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=cliente&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fclientelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fclientelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fclientelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function renderListOptionsExt()
    {
        ...
        $links = "";
        $btngrps = "";
        $sqlwrk = "`cliente`=" . AdjustSql($this->id->CurrentValue, $this->Dbid) . "";
        ...
        if ($this->DetailPages && $this->DetailPages["adjunto"] && $this->DetailPages["adjunto"]->Visible && $Security->allowList(CurrentProjectID() . 'adjunto')) {
            ...
            $url = "AdjuntoPreview?t=cliente&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'cliente')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("AdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=cliente&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
    ...
    protected function loadSearchValues()
    {
        ...
        // sucursal
        if (!$this->isAddOrEdit() && $this->sucursal->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // contacto
        if (!$this->isAddOrEdit() && $this->contacto->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // ciudad
        if (!$this->isAddOrEdit() && $this->ciudad->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // telefono1
        if (!$this->isAddOrEdit() && $this->telefono1->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // telefono2
        if (!$this->isAddOrEdit() && $this->telefono2->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // email1
        if (!$this->isAddOrEdit() && $this->email1->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // email2
        if (!$this->isAddOrEdit() && $this->email2->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // web
        if (!$this->isAddOrEdit() && $this->web->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipo_cliente
        if (!$this->isAddOrEdit() && $this->tipo_cliente->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tarifa
        if (!$this->isAddOrEdit() && $this->tarifa->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // cuenta
        if (!$this->isAddOrEdit() && $this->cuenta->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // refiere
        if (!$this->isAddOrEdit() && $this->refiere->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->refiere->AdvancedSearch->SearchValue != "" || $this->refiere->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // puntos_refiere
        if (!$this->isAddOrEdit() && $this->puntos_refiere->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->puntos_refiere->AdvancedSearch->SearchValue != "" || $this->puntos_refiere->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fclientelist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fclientelist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fclientelist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_cliente" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_cliente\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fclientelist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fclientelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
