...
class ContLotes extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('cont_lotes', 'cont_lotes', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // fecha
        $this->fecha = new DbField('cont_lotes', 'cont_lotes', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 133, 10, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // comprobante
        $this->comprobante = new DbField('cont_lotes', 'cont_lotes', 'x_comprobante', 'comprobante', '`comprobante`', '`comprobante`', 3, 11, -1, false, '`comprobante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nota
        $this->nota = new DbField('cont_lotes', 'cont_lotes', 'x_nota', 'nota', '`nota`', '`nota`', 200, 100, -1, false, '`nota`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // fecha_registro
        $this->fecha_registro = new DbField('cont_lotes', 'cont_lotes', 'x_fecha_registro', 'fecha_registro', '`fecha_registro`', CastDateFieldForLike("`fecha_registro`", 7, "DB"), 135, 19, 7, false, '`fecha_registro`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // usuario
        $this->usuario = new DbField('cont_lotes', 'cont_lotes', 'x_usuario', 'usuario', '`usuario`', '`usuario`', 200, 30, -1, false, '`usuario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ContLotesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ContLotesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ContLotesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ContLotesView";
            case Config("API_ADD_ACTION"):
                return "ContLotesAdd";
            case Config("API_EDIT_ACTION"):
                return "ContLotesEdit";
            case Config("API_DELETE_ACTION"):
                return "ContLotesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContLotesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ContLotesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ContLotesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ContLotesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ContLotesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContLotesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ContLotesDelete", $this->getUrlParm());
    }
