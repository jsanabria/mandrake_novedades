...
/**
 * Table class for view_articulo
 */
class ViewArticulo extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_articulo';
        $this->TableName = 'view_articulo';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_articulo`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_articulo', 'view_articulo', 'x_id', 'id', '`id`', '`id`', 19, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codigo
        $this->codigo = new DbField('view_articulo', 'view_articulo', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('view_articulo', 'view_articulo', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre_comercial
        $this->nombre_comercial = new DbField('view_articulo', 'view_articulo', 'x_nombre_comercial', 'nombre_comercial', '`nombre_comercial`', '`nombre_comercial`', 200, 50, -1, false, '`nombre_comercial`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // principio_activo
        $this->principio_activo = new DbField('view_articulo', 'view_articulo', 'x_principio_activo', 'principio_activo', '`principio_activo`', '`principio_activo`', 200, 100, -1, false, '`principio_activo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // presentacion
        $this->presentacion = new DbField('view_articulo', 'view_articulo', 'x_presentacion', 'presentacion', '`presentacion`', '`presentacion`', 200, 50, -1, false, '`presentacion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_en_mano
        $this->cantidad_en_mano = new DbField('view_articulo', 'view_articulo', 'x_cantidad_en_mano', 'cantidad_en_mano', '`cantidad_en_mano`', '`cantidad_en_mano`', 131, 9, -1, false, '`cantidad_en_mano`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ultimo_costo
        $this->ultimo_costo = new DbField('view_articulo', 'view_articulo', 'x_ultimo_costo', 'ultimo_costo', '`ultimo_costo`', '`ultimo_costo`', 131, 14, -1, false, '`ultimo_costo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante_nombre
        $this->fabricante_nombre = new DbField('view_articulo', 'view_articulo', 'x_fabricante_nombre', 'fabricante_nombre', '`fabricante_nombre`', '`fabricante_nombre`', 200, 80, -1, false, '`fabricante_nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codigo_ims
        $this->codigo_ims = new DbField('view_articulo', 'view_articulo', 'x_codigo_ims', 'codigo_ims', '`codigo_ims`', '`codigo_ims`', 200, 50, -1, false, '`codigo_ims`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // articulo
        $this->articulo = new DbField('view_articulo', 'view_articulo', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 11, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_real
        $this->cantidad_real = new DbField('view_articulo', 'view_articulo', 'x_cantidad_real', 'cantidad_real', '`cantidad_real`', '`cantidad_real`', 131, 32, -1, false, '`cantidad_real`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_articulo`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewArticuloList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewArticuloView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewArticuloEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewArticuloAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewArticuloView";
            case Config("API_ADD_ACTION"):
                return "ViewArticuloAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewArticuloEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewArticuloDelete";
            case Config("API_LIST_ACTION"):
                return "ViewArticuloList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewArticuloView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewArticuloView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewArticuloAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewArticuloAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewArticuloEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewArticuloAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewArticuloDelete", $this->getUrlParm());
    }
