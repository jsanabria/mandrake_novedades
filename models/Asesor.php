...
class Asesor extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('asesor', 'asesor', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // ci_rif
        $this->ci_rif = new DbField('asesor', 'asesor', 'x_ci_rif', 'ci_rif', '`ci_rif`', '`ci_rif`', 200, 30, -1, false, '`ci_rif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre
        $this->nombre = new DbField('asesor', 'asesor', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 80, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ciudad
        $this->ciudad = new DbField('asesor', 'asesor', 'x_ciudad', 'ciudad', '`ciudad`', '`ciudad`', 200, 6, -1, false, '`ciudad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // direccion
        $this->direccion = new DbField('asesor', 'asesor', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 200, 150, -1, false, '`direccion`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // telefono1
        $this->telefono1 = new DbField('asesor', 'asesor', 'x_telefono1', 'telefono1', '`telefono1`', '`telefono1`', 200, 20, -1, false, '`telefono1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // telefono2
        $this->telefono2 = new DbField('asesor', 'asesor', 'x_telefono2', 'telefono2', '`telefono2`', '`telefono2`', 200, 20, -1, false, '`telefono2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email1
        $this->email1 = new DbField('asesor', 'asesor', 'x_email1', 'email1', '`email1`', '`email1`', 200, 100, -1, false, '`email1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email2
        $this->email2 = new DbField('asesor', 'asesor', 'x_email2', 'email2', '`email2`', '`email2`', 200, 100, -1, false, '`email2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // web
        $this->web = new DbField('asesor', 'asesor', 'x_web', 'web', '`web`', '`web`', 200, 100, -1, false, '`web`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // activo
        $this->activo = new DbField('asesor', 'asesor', 'x_activo', 'activo', '`activo`', '`activo`', 202, 1, -1, false, '`activo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->activo->Lookup = new Lookup('activo', 'asesor', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("asesor_cliente")->loadRs("`asesor` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("asesor_fabricante")->loadRs("`asesor` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id';
                $rskey[$fldname] = $rsdtlold[$fldname];
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("asesor_cliente")->loadRs("`asesor` = " . QuotedValue($rs['id'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        ...
        $dtlrows = Container("asesor_fabricante")->loadRs("`asesor` = " . QuotedValue($rs['id'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AsesorEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AsesorAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsesorView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AsesorView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AsesorAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AsesorAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsesorEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AsesorEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsesorAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AsesorAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AsesorDelete", $this->getUrlParm());
    }
