...
class ViewEntradas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_entradas', 'view_entradas', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('view_entradas', 'view_entradas', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre_documento
        $this->nombre_documento = new DbField('view_entradas', 'view_entradas', 'x_nombre_documento', 'nombre_documento', '`nombre_documento`', '`nombre_documento`', 200, 30, -1, false, '`nombre_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // proveedor
        $this->proveedor = new DbField('view_entradas', 'view_entradas', 'x_proveedor', 'proveedor', '`proveedor`', '`proveedor`', 3, 11, -1, false, '`proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre_proveedor
        $this->nombre_proveedor = new DbField('view_entradas', 'view_entradas', 'x_nombre_proveedor', 'nombre_proveedor', '`nombre_proveedor`', '`nombre_proveedor`', 200, 80, -1, false, '`nombre_proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nombre_proveedor->Sortable = true; // Allow sort
        $this->nombre_proveedor->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->nombre_proveedor->Param, "CustomMsg");
        $this->Fields['nombre_proveedor'] = &$this->nombre_proveedor;

        // nro_documento
        $this->nro_documento = new DbField('view_entradas', 'view_entradas', 'x_nro_documento', 'nro_documento', '`nro_documento`', '`nro_documento`', 200, 20, -1, false, '`nro_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha
        $this->fecha = new DbField('view_entradas', 'view_entradas', 'x_fecha', 'fecha', '`fecha`', '`fecha`', 200, 10, -1, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // estatus
        $this->estatus = new DbField('view_entradas', 'view_entradas', 'x_estatus', 'estatus', '`estatus`', '`estatus`', 200, 10, -1, false, '`estatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // username
        $this->_username = new DbField('view_entradas', 'view_entradas', 'x__username', 'username', '`username`', '`username`', 200, 30, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nota
        $this->nota = new DbField('view_entradas', 'view_entradas', 'x_nota', 'nota', '`nota`', '`nota`', 201, 16777215, -1, false, '`nota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // consignacion
        $this->consignacion = new DbField('view_entradas', 'view_entradas', 'x_consignacion', 'consignacion', '`consignacion`', '`consignacion`', 202, 1, -1, false, '`consignacion`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->consignacion->Sortable = true; // Allow sort
        $this->consignacion->Lookup = new Lookup('consignacion', 'view_entradas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        $this->consignacion_reportada = new DbField('view_entradas', 'view_entradas', 'x_consignacion_reportada', 'consignacion_reportada', '`consignacion_reportada`', '`consignacion_reportada`', 202, 1, -1, false, '`consignacion_reportada`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->consignacion_reportada->Sortable = true; // Allow sort
        $this->consignacion_reportada->Lookup = new Lookup('consignacion_reportada', 'view_entradas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        global $Language;
        if ($pageName == "ViewEntradasView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewEntradasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewEntradasAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewEntradasView";
            case Config("API_ADD_ACTION"):
                return "ViewEntradasAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewEntradasEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewEntradasDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewEntradasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewEntradasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewEntradasAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewEntradasAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewEntradasEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewEntradasEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewEntradasAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewEntradasAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewEntradasDelete", $this->getUrlParm());
    }
