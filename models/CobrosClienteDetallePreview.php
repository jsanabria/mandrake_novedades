 ...
 * Page class
 */
class CobrosClienteDetallePreview extends CobrosClienteDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteDetallePreview";
        ...
        if ($masterTblVar == "cobros_cliente") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->cobros_cliente->setQueryStringValue($val);
            }
        }
    }
