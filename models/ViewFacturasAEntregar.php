...
class ViewFacturasAEntregar extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codcli
        $this->codcli = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_codcli', 'codcli', '`codcli`', '`codcli`', 3, 11, -1, false, '`codcli`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // nro_documento
        $this->nro_documento = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_nro_documento', 'nro_documento', '`nro_documento`', '`nro_documento`', 200, 20, -1, false, '`nro_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cliente
        $this->cliente = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_cliente', 'cliente', '`cliente`', '`cliente`', 200, 80, -1, false, '`cliente`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha
        $this->fecha = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 135, 19, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // total
        $this->total = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_total', 'total', '`total`', '`total`', 131, 14, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // entregado
        $this->entregado = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_entregado', 'entregado', '`entregado`', '`entregado`', 202, 1, -1, false, '`entregado`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->entregado->Lookup = new Lookup('entregado', 'view_facturas_a_entregar', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // fecha_entrega
        $this->fecha_entrega = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_fecha_entrega', 'fecha_entrega', '`fecha_entrega`', CastDateFieldForLike("`fecha_entrega`", 7, "DB"), 133, 10, 7, false, '`fecha_entrega`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dias_credito
        $this->dias_credito = new DbField('view_facturas_a_entregar', 'view_facturas_a_entregar', 'x_dias_credito', 'dias_credito', '`dias_credito`', '`dias_credito`', 16, 4, -1, false, '`dias_credito`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewFacturasAEntregarEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewFacturasAEntregarAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewFacturasAEntregarView";
            case Config("API_ADD_ACTION"):
                return "ViewFacturasAEntregarAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewFacturasAEntregarEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewFacturasAEntregarDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFacturasAEntregarView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewFacturasAEntregarView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewFacturasAEntregarAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewFacturasAEntregarDelete", $this->getUrlParm());
    }
