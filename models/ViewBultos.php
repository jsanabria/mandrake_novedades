...
class ViewBultos extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_bultos', 'view_bultos', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // cliente
        $this->cliente = new DbField('view_bultos', 'view_bultos', 'x_cliente', 'cliente', '`cliente`', '`cliente`', 200, 80, -1, false, '`cliente`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ciudad
        $this->ciudad = new DbField('view_bultos', 'view_bultos', 'x_ciudad', 'ciudad', '`ciudad`', '`ciudad`', 200, 150, -1, false, '`ciudad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // direccion
        $this->direccion = new DbField('view_bultos', 'view_bultos', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 200, 150, -1, false, '`direccion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nro_documento
        $this->nro_documento = new DbField('view_bultos', 'view_bultos', 'x_nro_documento', 'nro_documento', '`nro_documento`', '`nro_documento`', 200, 20, -1, false, '`nro_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // asesor
        $this->asesor = new DbField('view_bultos', 'view_bultos', 'x_asesor', 'asesor', '`asesor`', '`asesor`', 200, 30, -1, false, '`asesor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->asesor->Sortable = true; // Allow sort
        $this->asesor->Lookup = new Lookup('asesor', 'usuario', false, 'username', ["nombre","","",""], [], [], [], [], [], [], '', '');
        $this->asesor->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->asesor->Param, "CustomMsg");
        $this->Fields['asesor'] = &$this->asesor;

        // bultos
        $this->bultos = new DbField('view_bultos', 'view_bultos', 'x_bultos', 'bultos', '`bultos`', '`bultos`', 16, 4, -1, false, '`bultos`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha_despacho
        $this->fecha_despacho = new DbField('view_bultos', 'view_bultos', 'x_fecha_despacho', 'fecha_despacho', '`fecha_despacho`', CastDateFieldForLike("`fecha_despacho`", 11, "DB"), 135, 19, 11, false, '`fecha_despacho`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user_despacho
        $this->user_despacho = new DbField('view_bultos', 'view_bultos', 'x_user_despacho', 'user_despacho', '`user_despacho`', '`user_despacho`', 200, 30, -1, false, '`user_despacho`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ViewBultosView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewBultosEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewBultosAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBultosView";
            case Config("API_ADD_ACTION"):
                return "ViewBultosAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBultosEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBultosDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBultosView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewBultosView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewBultosAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewBultosAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewBultosEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBultosAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewBultosDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->fecha_despacho->EditValue = FormatDateTime($this->fecha_despacho->CurrentValue, 11);
