...
$sql = "select tipo, notificacion, notificar, notificados, enviado, asunto from notificaciones a where Nnotificaciones = '$id';"; 
...
<body>
    ...
    <div class="easyui-panel" title="Nuevo Mensaje" style="width:1000px">
        ...
        <form id="ff" name="ff" method="post" enctype="multipart/form-data" action="save_email.php">
            <table cellpadding="5">
                <!--<tr>
                    <td>Mensaje a:</td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <!--<input class="easyui-textbox" style="height:32px;width:600px" name="tipo" value="<?php echo $tipo; ?>">-->
                      <input type="hidden" name="username" value="<?php echo $username; ?>" />
                      <input type="hidden" name="id" value="<?php echo $id; ?>" />
                      <input type="hidden" name="seleccion" value="<?php echo $notificados; ?>" />
					          </td>
                </tr>
                <tr>
                    <td>Mensaje:</td>
                    <td>
					  ...
					  <textarea id="notificacion" name="notificacion" placeholder="Coloque el texto ..."><?php echo $notificacion; ?></textarea>
					</td>
                </tr>
                <tr>
                    <td>Notificar:</td>
                    <td>
						<input class="easyui-textbox" data-options="editable:false" style="width:850px;height:32px" name="notificar" value="<?php echo $notificar; ?>">
					</td>
                </tr>
                <tr>
                    <td>Seleccione:</td>
                    <td>
						<div id="aNotificar" title="Checkbox in DataList" style="border-style: solid;border-color:green;border-radius:5px;width:850px;height:200px;overflow:auto">
							<?php 
							$arSel = explode(",",$notificados);
							foreach($arSel as $ar)
							{
								if(trim($ar)!="") echo '<br /><input type="checkbox" checked="checked" disabled="disabled" id="old_seleccion[]" name="old_seleccion[]" value="'.$ar.'" />'.$ar.' -- ENVIADO: <b><i>'.($enviado==0?'NO':'SI').'</i></b>';
							}
							?>
						</div>
					</td>
			...
			<div style="text-align:center;padding:5px">
				<select class="easyui-combobox" name="guardayyenviar" style="width:150px" data-options="panelHeight:'auto',editable:false">
					<!--<option value="off" <?php ($enviado==0?'selected="selected"':''); ?>>Guardar sin Enviar</option>
					<option value="on" <?php ($enviado==1?'selected="selected"':''); ?>>Guardar y Enviar</option>-->
          <option value="off">Guardar</option>
				</select>
