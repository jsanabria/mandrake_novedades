...
loadjs.ready("head", function () {
    ...
    ftarifa_articuloedit = currentForm = new ew.Form("ftarifa_articuloedit", "edit");
    ...
    ftarifa_articuloedit.addFields([
    ...
    // Validate form
    ftarifa_articuloedit.validate = function () {
    ...
    // Form_CustomValidate
    ftarifa_articuloedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftarifa_articuloedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    ftarifa_articuloedit.lists.fabricante = <?= $Page->fabricante->toClientList($Page) ?>;
    ftarifa_articuloedit.lists.articulo = <?= $Page->articulo->toClientList($Page) ?>;
    loadjs.done("ftarifa_articuloedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftarifa_articuloedit" id="ftarifa_articuloedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
