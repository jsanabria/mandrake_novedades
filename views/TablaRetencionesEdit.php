...
loadjs.ready("head", function () {
    ...
    ftabla_retencionesedit = currentForm = new ew.Form("ftabla_retencionesedit", "edit");
    ...
    ftabla_retencionesedit.addFields([
    ...
    // Validate form
    ftabla_retencionesedit.validate = function () {
    ...
    // Form_CustomValidate
    ftabla_retencionesedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftabla_retencionesedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    ftabla_retencionesedit.lists.codigo = <?= $Page->codigo->toClientList($Page) ?>;
    ftabla_retencionesedit.lists.tipo = <?= $Page->tipo->toClientList($Page) ?>;
    ftabla_retencionesedit.lists.activo = <?= $Page->activo->toClientList($Page) ?>;
    loadjs.done("ftabla_retencionesedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="ftabla_retencionesedit" id="ftabla_retencionesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
