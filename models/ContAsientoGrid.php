...
class ContAsientoGrid extends ContAsiento
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_nota") && $CurrentForm->hasValue("o_nota") && $this->nota->CurrentValue != $this->nota->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_debe") && $CurrentForm->hasValue("o_debe") && $this->debe->CurrentValue != $this->debe->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_haber") && $CurrentForm->hasValue("o_haber") && $this->haber->CurrentValue != $this->haber->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->nota->clearErrorMessage();
        $this->referencia->clearErrorMessage();
        $this->debe->clearErrorMessage();
        $this->haber->clearErrorMessage();
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->debe->EditValue) != "" && is_numeric($this->debe->EditValue)) {
                ...
                $this->debe->OldValue = $this->debe->EditValue;
            }
            ...
            if (strval($this->haber->EditValue) != "" && is_numeric($this->haber->EditValue)) {
                ...
                $this->haber->OldValue = $this->haber->EditValue;
            }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // debe
            $this->debe->setDbValueDef($rsnew, $this->debe->CurrentValue, null, $this->debe->ReadOnly);

            // haber
            $this->haber->setDbValueDef($rsnew, $this->haber->CurrentValue, null, $this->haber->ReadOnly);
