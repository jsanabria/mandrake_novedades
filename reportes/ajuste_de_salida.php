...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(100, 6, "ARTICULO", 1, 0, 'L');
		$this->Cell(20, 6, "LOTE", 1, 0, 'L');
		$this->Cell(15, 6, "VENCE", 1, 0, 'L');
		$this->Cell(15, 6, "U. MED.", 1, 0, 'C');
...
while($row = mysqli_fetch_array($rs))
{
	...
	if(strlen($row["articulo"]) < 55) 
		$pdf->Cell(100, 4, $row["articulo"], 0, 0, 'L');
	else 
		$pdf->Cell(100, 4, substr($row["articulo"], 0, 55), 0, 0, 'L');
	$pdf->Cell(20, 4, $row["lote"], 0, 0, 'C');
	$pdf->Cell(15, 4, $row["fecha_vencimiento"], 0, 0, 'C');
	$pdf->Cell(15, 4, $row["unidad_medida"], 0, 0, 'C');
