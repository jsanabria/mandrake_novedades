...
class ViewBanco extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_banco', 'view_banco', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // codigo
        $this->codigo = new DbField('view_banco', 'view_banco', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // banco
        $this->banco = new DbField('view_banco', 'view_banco', 'x_banco', 'banco', '`banco`', '`banco`', 200, 150, -1, false, '`banco`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // numero
        $this->numero = new DbField('view_banco', 'view_banco', 'x_numero', 'numero', '`numero`', '`numero`', 200, 40, -1, false, '`numero`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cuenta
        $this->cuenta = new DbField('view_banco', 'view_banco', 'x_cuenta', 'cuenta', '`cuenta`', '`cuenta`', 19, 10, -1, false, '`cuenta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pago_electronico
        $this->pago_electronico = new DbField('view_banco', 'view_banco', 'x_pago_electronico', 'pago_electronico', '`pago_electronico`', '`pago_electronico`', 202, 1, -1, false, '`pago_electronico`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->pago_electronico->Nullable = false; // NOT NULL field
        $this->pago_electronico->Sortable = true; // Allow sort
        $this->pago_electronico->Lookup = new Lookup('pago_electronico', 'view_banco', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        global $Language;
        if ($pageName == "ViewBancoView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewBancoEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewBancoAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBancoView";
            case Config("API_ADD_ACTION"):
                return "ViewBancoAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBancoEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBancoDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBancoView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewBancoView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewBancoAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewBancoAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewBancoEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBancoAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewBancoDelete", $this->getUrlParm());
    }
