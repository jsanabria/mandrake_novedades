...
loadjs.ready("head", function () {
    ...
    fcierre_de_cajaadd = currentForm = new ew.Form("fcierre_de_cajaadd", "add");
    ...
    // Validate form
    fcierre_de_cajaadd.validate = function () {
    ...
    // Form_CustomValidate
    fcierre_de_cajaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcierre_de_cajaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcierre_de_cajaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcierre_de_cajaadd" id="fcierre_de_cajaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fcierre_de_cajaadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcierre_de_cajaadd", "x_fecha", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
