...
class TasaUsdEdit extends TasaUsd
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->tasa->EditValue = HtmlEncode($this->tasa->CurrentValue);
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // tasa
            $this->tasa->setDbValueDef($rsnew, $this->tasa->CurrentValue, null, $this->tasa->ReadOnly);

            // fecha
            $this->fecha->CurrentValue = CurrentDate();
            $this->fecha->setDbValueDef($rsnew, $this->fecha->CurrentValue, null);

            // hora
            $this->hora->CurrentValue = CurrentTime();
            $this->hora->setDbValueDef($rsnew, $this->hora->CurrentValue, null);
