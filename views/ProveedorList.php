...
loadjs.ready("head", function () {
    ...
    // Set invalid fields
    $(function() {
        fproveedorlistsrch.setInvalid();
    });

    // Validate form
    fproveedorlistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fproveedorlistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fproveedorlistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fproveedorlistsrch.lists.activo = <?= $Page->activo->toClientList($Page) ?>;

    // Filters
    fproveedorlistsrch.filterList = <?= $Page->getFilterList() ?>;

    // Init search panel as collapsed
    fproveedorlistsrch.initSearchPanel = true;
...
<input type="hidden" name="z_activo" id="z_activo" value="=">
        ...
        <span id="el_proveedor_activo" class="ew-search-field">
    <select
        id="x_activo"
        name="x_activo"
...
<?php if ($Page->ci_rif->Visible) { // ci_rif ?>
        <th data-name="ci_rif" class="<?= $Page->ci_rif->headerCellClass() ?>"><div id="elh_proveedor_ci_rif" class="proveedor_ci_rif"><?= $Page->renderSort($Page->ci_rif) ?></div></th>
<?php } ?>
<?php if ($Page->nombre->Visible) { // nombre ?>
        <th data-name="nombre" class="<?= $Page->nombre->headerCellClass() ?>"><div id="elh_proveedor_nombre" class="proveedor_nombre"><?= $Page->renderSort($Page->nombre) ?></div></th>
<?php } ?>
<?php if ($Page->activo->Visible) { // activo ?>
        <th data-name="activo" class="<?= $Page->activo->headerCellClass() ?>"><div id="elh_proveedor_activo" class="proveedor_activo"><?= $Page->renderSort($Page->activo) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_proveedor_ci_rif">
...
<span id="el<?= $Page->RowCount ?>_proveedor_nombre">
...
<span id="el<?= $Page->RowCount ?>_proveedor_activo">
