...
/**
 * Table class for view_saldos2
 */
class ViewSaldos2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_saldos2';
        $this->TableName = 'view_saldos2';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_saldos2`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nombre
        $this->nombre = new DbField('view_saldos2', 'view_saldos2', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 80, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ci_rif
        $this->ci_rif = new DbField('view_saldos2', 'view_saldos2', 'x_ci_rif', 'ci_rif', '`ci_rif`', '`ci_rif`', 200, 30, -1, false, '`ci_rif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codigo
        $this->codigo = new DbField('view_saldos2', 'view_saldos2', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 6, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // saldo
        $this->saldo = new DbField('view_saldos2', 'view_saldos2', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 131, 36, -1, false, '`saldo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_saldos2`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewSaldos2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewSaldos2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewSaldos2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewSaldos2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewSaldos2View";
            case Config("API_ADD_ACTION"):
                return "ViewSaldos2Add";
            case Config("API_EDIT_ACTION"):
                return "ViewSaldos2Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewSaldos2Delete";
            case Config("API_LIST_ACTION"):
                return "ViewSaldos2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewSaldos2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewSaldos2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewSaldos2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewSaldos2Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewSaldos2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewSaldos2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewSaldos2Delete", $this->getUrlParm());
    }
