...
class TempConsignacionAdd extends TempConsignacion
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cantidad_entre_fechas->CurrentValue = null;
        $this->cantidad_entre_fechas->OldValue = $this->cantidad_entre_fechas->CurrentValue;
        $this->cantidad_acumulada->CurrentValue = null;
        $this->cantidad_acumulada->OldValue = $this->cantidad_acumulada->CurrentValue;
        $this->cantidad_ajuste->CurrentValue = null;
        $this->cantidad_ajuste->OldValue = $this->cantidad_ajuste->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['cantidad_entre_fechas'] = $this->cantidad_entre_fechas->CurrentValue;
        $row['cantidad_acumulada'] = $this->cantidad_acumulada->CurrentValue;
        $row['cantidad_ajuste'] = $this->cantidad_ajuste->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // id_documento
        $this->id_documento->setDbValueDef($rsnew, $this->id_documento->CurrentValue, null, false);
        ...
        // cantidad_movimiento
        $this->cantidad_movimiento->setDbValueDef($rsnew, $this->cantidad_movimiento->CurrentValue, null, false);

        // cantidad_entre_fechas
        $this->cantidad_entre_fechas->setDbValueDef($rsnew, $this->cantidad_entre_fechas->CurrentValue, null, false);

        // cantidad_acumulada
        $this->cantidad_acumulada->setDbValueDef($rsnew, $this->cantidad_acumulada->CurrentValue, null, false);

        // cantidad_ajuste
        $this->cantidad_ajuste->setDbValueDef($rsnew, $this->cantidad_ajuste->CurrentValue, null, false);
