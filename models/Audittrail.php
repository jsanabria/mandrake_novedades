...
class Audittrail extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('audittrail', 'audittrail', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // datetime
        $this->datetime = new DbField('audittrail', 'audittrail', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 11, "DB"), 135, 19, 11, false, '`datetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
