...
loadjs.ready("head", function () {
    ...
    falicuotaedit = currentForm = new ew.Form("falicuotaedit", "edit");
    ...
    // Validate form
    falicuotaedit.validate = function () {
    ...
    // Form_CustomValidate
    falicuotaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    falicuotaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("falicuotaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="falicuotaedit" id="falicuotaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
