...
class ContMesContable extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tipo_comprobante
        $this->tipo_comprobante = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_tipo_comprobante', 'tipo_comprobante', '`tipo_comprobante`', '`tipo_comprobante`', 200, 6, -1, false, '`tipo_comprobante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tipo_comprobante->Sortable = true; // Allow sort
        $this->tipo_comprobante->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->tipo_comprobante->Param, "CustomMsg");
        $this->Fields['tipo_comprobante'] = &$this->tipo_comprobante;

        // descripcion
        $this->descripcion = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, 50, -1, false, '`descripcion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // M01
        $this->M01 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M01', 'M01', '`M01`', '`M01`', 202, 1, -1, false, '`M01`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M01->Sortable = true; // Allow sort
        $this->M01->Lookup = new Lookup('M01', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M02
        $this->M02 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M02', 'M02', '`M02`', '`M02`', 202, 1, -1, false, '`M02`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M02->Sortable = true; // Allow sort
        $this->M02->Lookup = new Lookup('M02', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M03
        $this->M03 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M03', 'M03', '`M03`', '`M03`', 202, 1, -1, false, '`M03`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M03->Sortable = true; // Allow sort
        $this->M03->Lookup = new Lookup('M03', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M04
        $this->M04 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M04', 'M04', '`M04`', '`M04`', 202, 1, -1, false, '`M04`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M04->Sortable = true; // Allow sort
        $this->M04->Lookup = new Lookup('M04', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M05
        $this->M05 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M05', 'M05', '`M05`', '`M05`', 202, 1, -1, false, '`M05`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M05->Sortable = true; // Allow sort
        $this->M05->Lookup = new Lookup('M05', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M06
        $this->M06 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M06', 'M06', '`M06`', '`M06`', 202, 1, -1, false, '`M06`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M06->Sortable = true; // Allow sort
        $this->M06->Lookup = new Lookup('M06', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M07
        $this->M07 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M07', 'M07', '`M07`', '`M07`', 202, 1, -1, false, '`M07`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M07->Sortable = true; // Allow sort
        $this->M07->Lookup = new Lookup('M07', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M08
        $this->M08 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M08', 'M08', '`M08`', '`M08`', 202, 1, -1, false, '`M08`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M08->Sortable = true; // Allow sort
        $this->M08->Lookup = new Lookup('M08', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M09
        $this->M09 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M09', 'M09', '`M09`', '`M09`', 202, 1, -1, false, '`M09`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M09->Sortable = true; // Allow sort
        $this->M09->Lookup = new Lookup('M09', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M10
        $this->M10 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M10', 'M10', '`M10`', '`M10`', 202, 1, -1, false, '`M10`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M10->Sortable = true; // Allow sort
        $this->M10->Lookup = new Lookup('M10', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M11
        $this->M11 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M11', 'M11', '`M11`', '`M11`', 202, 1, -1, false, '`M11`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M11->Sortable = true; // Allow sort
        $this->M11->Lookup = new Lookup('M11', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // M12
        $this->M12 = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_M12', 'M12', '`M12`', '`M12`', 202, 1, -1, false, '`M12`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->M12->Sortable = true; // Allow sort
        $this->M12->Lookup = new Lookup('M12', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // activo
        $this->activo = new DbField('cont_mes_contable', 'cont_mes_contable', 'x_activo', 'activo', '`activo`', '`activo`', 202, 1, -1, false, '`activo`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->activo->Sortable = true; // Allow sort
        $this->activo->Lookup = new Lookup('activo', 'cont_mes_contable', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ContMesContableEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ContMesContableAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ContMesContableView";
            case Config("API_ADD_ACTION"):
                return "ContMesContableAdd";
            case Config("API_EDIT_ACTION"):
                return "ContMesContableEdit";
            case Config("API_DELETE_ACTION"):
                return "ContMesContableDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContMesContableView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ContMesContableView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ContMesContableAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ContMesContableEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContMesContableAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ContMesContableDelete", $this->getUrlParm());
    }
