...
class CobrosClienteDetalleEdit extends CobrosClienteDetalle
{
    ...
    public function run()
    {
        ...
        $this->cobros_cliente->Required = false;
        $this->metodo_pago->Required = false;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'cobros_cliente' first before field var 'x_cobros_cliente'
        $val = $CurrentForm->hasValue("cobros_cliente") ? $CurrentForm->getValue("cobros_cliente") : $CurrentForm->getValue("x_cobros_cliente");
        if (!$this->cobros_cliente->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->cobros_cliente->Visible = false; // Disable update for API request
            } else {
                $this->cobros_cliente->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->cobros_cliente->CurrentValue = $this->cobros_cliente->FormValue;
    ...
    protected function validateForm()
    {
        ...
        if ($this->cobros_cliente->Required) {
            if (!$this->cobros_cliente->IsDetailKey && EmptyValue($this->cobros_cliente->FormValue)) {
                $this->cobros_cliente->addErrorMessage(str_replace("%s", $this->cobros_cliente->caption(), $this->cobros_cliente->RequiredErrorMessage));
            }
        }
