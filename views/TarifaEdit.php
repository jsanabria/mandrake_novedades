...
loadjs.ready("head", function () {
    ...
    ftarifaedit = currentForm = new ew.Form("ftarifaedit", "edit");
    ...
    // Form_CustomValidate
    ftarifaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftarifaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    ftarifaedit.lists.patron = <?= $Page->patron->toClientList($Page) ?>;
    ftarifaedit.lists.activo = <?= $Page->activo->toClientList($Page) ?>;
    loadjs.done("ftarifaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="ftarifaedit" id="ftarifaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
