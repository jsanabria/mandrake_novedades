...
loadjs.ready("head", function () {
    ...
    fasesor_clienteedit = currentForm = new ew.Form("fasesor_clienteedit", "edit");
    ...
    // Validate form
    fasesor_clienteedit.validate = function () {
    ...
    // Form_CustomValidate
    fasesor_clienteedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fasesor_clienteedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fasesor_clienteedit.lists.cliente = <?= $Page->cliente->toClientList($Page) ?>;
    loadjs.done("fasesor_clienteedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fasesor_clienteedit" id="fasesor_clienteedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
