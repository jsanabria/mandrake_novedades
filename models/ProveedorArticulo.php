...
class ProveedorArticulo extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('proveedor_articulo', 'proveedor_articulo', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // proveedor
        $this->proveedor = new DbField('proveedor_articulo', 'proveedor_articulo', 'x_proveedor', 'proveedor', '`proveedor`', '`proveedor`', 19, 10, -1, false, '`proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('proveedor_articulo', 'proveedor_articulo', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // articulo
        $this->articulo = new DbField('proveedor_articulo', 'proveedor_articulo', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->articulo->Lookup = new Lookup('articulo', 'articulo', false, 'id', ["principio_activo","presentacion","nombre_comercial",""], ["x_fabricante"], [], ["fabricante"], ["x_fabricante"], [], [], '', '');
        ...
        // codigo_proveedor
        $this->codigo_proveedor = new DbField('proveedor_articulo', 'proveedor_articulo', 'x_codigo_proveedor', 'codigo_proveedor', '`codigo_proveedor`', '`codigo_proveedor`', 200, 30, -1, false, '`codigo_proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->codigo_proveedor->Sortable = true; // Allow sort
        $this->codigo_proveedor->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->codigo_proveedor->Param, "CustomMsg");
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "proveedor") {
            if ($this->proveedor->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->proveedor->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "proveedor") {
            if ($this->proveedor->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`proveedor`", $this->proveedor->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_proveedor()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_proveedor()
    {
    ...
    {
        global $Language;
        if ($pageName == "ProveedorArticuloView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ProveedorArticuloEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ProveedorArticuloAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProveedorArticuloView";
            case Config("API_ADD_ACTION"):
                return "ProveedorArticuloAdd";
            case Config("API_EDIT_ACTION"):
                return "ProveedorArticuloEdit";
            case Config("API_DELETE_ACTION"):
                return "ProveedorArticuloDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ProveedorArticuloView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ProveedorArticuloView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ProveedorArticuloAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ProveedorArticuloEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ProveedorArticuloAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ProveedorArticuloDelete", $this->getUrlParm());
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "proveedor" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->proveedor->CurrentValue ?? $this->proveedor->getSessionValue());
        }
        return $url;
    }
