...
class ChangePassword extends Usuario
{
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("usuario", "usuario", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("usuario", "usuario", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("usuario", "usuario", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
