 ...
 * Page class
 */
class ContLotesPagosDetalleEdit extends ContLotesPagosDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosDetalleEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ContLotesPagosDetalleList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ContLotesPagosDetalleList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // monto_a_pagar
            $this->monto_a_pagar->setDbValueDef($rsnew, $this->monto_a_pagar->CurrentValue, null, $this->monto_a_pagar->ReadOnly);

            // monto_pagado
            $this->monto_pagado->setDbValueDef($rsnew, $this->monto_pagado->CurrentValue, null, $this->monto_pagado->ReadOnly);
