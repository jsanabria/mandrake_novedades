...
class PagosProveedorFactura extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // pagos_proveedor
        $this->pagos_proveedor = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_pagos_proveedor', 'pagos_proveedor', '`pagos_proveedor`', '`pagos_proveedor`', 19, 10, -1, false, '`pagos_proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->pagos_proveedor->IsForeignKey = true; // Foreign key field
        $this->pagos_proveedor->Sortable = true; // Allow sort
        $this->pagos_proveedor->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->pagos_proveedor->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->pagos_proveedor->Param, "CustomMsg");
        $this->Fields['pagos_proveedor'] = &$this->pagos_proveedor;

        // tipo_documento
        $this->tipo_documento = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tipo_documento->Sortable = true; // Allow sort
        $this->tipo_documento->Lookup = new Lookup('tipo_documento', 'cont_mes_contable', false, 'tipo_comprobante', ["descripcion","","",""], [], [], [], [], [], [], '', '');
        ...
        // id_documento
        $this->id_documento = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_id_documento', 'id_documento', '`id_documento`', '`id_documento`', 19, 10, -1, false, '`id_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // abono
        $this->abono = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_abono', 'abono', '`abono`', '`abono`', 202, 1, -1, false, '`abono`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->abono->Sortable = true; // Allow sort
        $this->abono->Lookup = new Lookup('abono', 'pagos_proveedor_factura', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // monto
        $this->monto = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_monto', 'monto', '`monto`', '`monto`', 131, 14, -1, false, '`monto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // comprobante
        $this->comprobante = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_comprobante', 'comprobante', '`comprobante`', '`comprobante`', 3, 11, -1, false, '`comprobante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retiva
        $this->retiva = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_retiva', 'retiva', '`retiva`', '`retiva`', 200, 15, -1, false, '`retiva`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retivamonto
        $this->retivamonto = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_retivamonto', 'retivamonto', '`retivamonto`', '`retivamonto`', 131, 14, -1, false, '`retivamonto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retislr
        $this->retislr = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_retislr', 'retislr', '`retislr`', '`retislr`', 200, 15, -1, false, '`retislr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retislrmonto
        $this->retislrmonto = new DbField('pagos_proveedor_factura', 'pagos_proveedor_factura', 'x_retislrmonto', 'retislrmonto', '`retislrmonto`', '`retislrmonto`', 131, 14, -1, false, '`retislrmonto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pagos_proveedor") {
            if ($this->pagos_proveedor->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->pagos_proveedor->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pagos_proveedor") {
            if ($this->pagos_proveedor->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`pagos_proveedor`", $this->pagos_proveedor->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_pagos_proveedor()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_pagos_proveedor()
    {
        return "`pagos_proveedor`=@pagos_proveedor@";
    }
    ...
    {
        global $Language;
        if ($pageName == "PagosProveedorFacturaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PagosProveedorFacturaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PagosProveedorFacturaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PagosProveedorFacturaView";
            case Config("API_ADD_ACTION"):
                return "PagosProveedorFacturaAdd";
            case Config("API_EDIT_ACTION"):
                return "PagosProveedorFacturaEdit";
            case Config("API_DELETE_ACTION"):
                return "PagosProveedorFacturaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosProveedorFacturaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PagosProveedorFacturaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PagosProveedorFacturaAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PagosProveedorFacturaDelete", $this->getUrlParm());
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "pagos_proveedor" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->pagos_proveedor->CurrentValue ?? $this->pagos_proveedor->getSessionValue());
        }
        return $url;
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->pagos_proveedor->ViewCustomAttributes = "";
        ...
        // pagos_proveedor
        $this->pagos_proveedor->LinkCustomAttributes = "";
    ...
    public function renderEditRow()
    {
        ...
        // pagos_proveedor
        $this->pagos_proveedor->EditAttrs["class"] = "form-control";
        $this->pagos_proveedor->EditCustomAttributes = "";
        if ($this->pagos_proveedor->getSessionValue() != "") {
