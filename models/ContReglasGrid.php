...
class ContReglasGrid extends ContReglas
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_cargo") && $CurrentForm->hasValue("o_cargo") && $this->cargo->CurrentValue != $this->cargo->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->descripcion->clearErrorMessage();
        $this->cuenta->clearErrorMessage();
        $this->cargo->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->regla->CurrentValue = null;
        $this->regla->OldValue = $this->regla->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['regla'] = $this->regla->CurrentValue;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            $masterFilter = $this->sqlMasterFilter_cont_reglas_hr();
            ...
            if ($validMasterRecord) {
                $rsmaster = Container("cont_reglas_hr")->loadRs($masterFilter)->fetch();
    ...
    protected function addRow($rsold = null)
    {
        ...
        $masterFilter = str_replace("@id@", AdjustSql($this->regla->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
