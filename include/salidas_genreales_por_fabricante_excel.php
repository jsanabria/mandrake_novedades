<?php 
	...
	$sql = "SELECT 
				...
				i.principio_activo AS articulo, j.unidad_medida, 
				j.cantidad 
			FROM 
				(SELECT 
					a.id AS articulo, a.codigo_ims AS codigo, b.nombre AS fabricante, 
				...
				LEFT OUTER JOIN  
				(SELECT
					b.articulo, d.codigo_ims AS codigo, f.descripcion AS almacen, c.nombre AS fabricante, 
	...
	$filename = "SALIDAS_FABRICANTE_" . date('Ymd') . ".xls";
