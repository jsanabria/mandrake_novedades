...
class TarifaAnterior extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha
        $this->fecha = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 133, 10, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tarifa
        $this->tarifa = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_tarifa', 'tarifa', '`tarifa`', '`tarifa`', 19, 10, -1, false, '`tarifa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tarifa->Sortable = true; // Allow sort
        $this->tarifa->Lookup = new Lookup('tarifa', 'tarifa', false, 'id', ["nombre","","",""], [], [], [], [], [], [], '', '');
        ...
        // codigo
        $this->codigo = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // articulo
        $this->articulo = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->articulo->Sortable = true; // Allow sort
        $this->articulo->Lookup = new Lookup('articulo', 'articulo', false, 'id', ["nombre_comercial","principio_activo","presentacion",""], [], [], [], [], [], [], '', '');
        ...
        // precio_anterior
        $this->precio_anterior = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_precio_anterior', 'precio_anterior', '`precio_anterior`', '`precio_anterior`', 131, 13, -1, false, '`precio_anterior`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->precio_anterior->Sortable = true; // Allow sort
        $this->precio_anterior->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->precio_anterior->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->precio_anterior->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->precio_anterior->Param, "CustomMsg");
        $this->Fields['precio_anterior'] = &$this->precio_anterior;

        // precio_nuevo
        $this->precio_nuevo = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_precio_nuevo', 'precio_nuevo', '`precio_nuevo`', '`precio_nuevo`', 131, 13, -1, false, '`precio_nuevo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->precio_nuevo->Sortable = true; // Allow sort
        $this->precio_nuevo->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->precio_nuevo->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->precio_nuevo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->precio_nuevo->Param, "CustomMsg");
        $this->Fields['precio_nuevo'] = &$this->precio_nuevo;

        // activo
        $this->activo = new DbField('tarifa_anterior', 'tarifa_anterior', 'x_activo', 'activo', '`activo`', '`activo`', 202, 1, -1, false, '`activo`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->activo->Sortable = true; // Allow sort
        $this->activo->Lookup = new Lookup('activo', 'tarifa_anterior', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        global $Language;
        if ($pageName == "TarifaAnteriorView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifaAnteriorEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifaAnteriorAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TarifaAnteriorView";
            case Config("API_ADD_ACTION"):
                return "TarifaAnteriorAdd";
            case Config("API_EDIT_ACTION"):
                return "TarifaAnteriorEdit";
            case Config("API_DELETE_ACTION"):
                return "TarifaAnteriorDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaAnteriorView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifaAnteriorView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifaAnteriorAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("TarifaAnteriorEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaAnteriorAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifaAnteriorDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->precio_anterior->EditValue) != "" && is_numeric($this->precio_anterior->EditValue)) {
            $this->precio_anterior->EditValue = FormatNumber($this->precio_anterior->EditValue, -2, -1, -2, -1);
        }
        ...
        if (strval($this->precio_nuevo->EditValue) != "" && is_numeric($this->precio_nuevo->EditValue)) {
            $this->precio_nuevo->EditValue = FormatNumber($this->precio_nuevo->EditValue, -2, -1, -2, -1);
        }
