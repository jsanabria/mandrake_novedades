...
class ContPlancta extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('cont_plancta', 'cont_plancta', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // clase
        $this->clase = new DbField('cont_plancta', 'cont_plancta', 'x_clase', 'clase', '`clase`', '`clase`', 200, 6, -1, false, '`clase`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->clase->Required = true; // Required field
        $this->clase->Sortable = true; // Allow sort
        $this->clase->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->clase->Param, "CustomMsg");
        $this->Fields['clase'] = &$this->clase;

        // grupo
        $this->grupo = new DbField('cont_plancta', 'cont_plancta', 'x_grupo', 'grupo', '`grupo`', '`grupo`', 200, 6, -1, false, '`grupo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cuenta
        $this->cuenta = new DbField('cont_plancta', 'cont_plancta', 'x_cuenta', 'cuenta', '`cuenta`', '`cuenta`', 200, 6, -1, false, '`cuenta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // subcuenta
        $this->subcuenta = new DbField('cont_plancta', 'cont_plancta', 'x_subcuenta', 'subcuenta', '`subcuenta`', '`subcuenta`', 200, 6, -1, false, '`subcuenta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->subcuenta->Sortable = true; // Allow sort
        $this->subcuenta->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->subcuenta->Param, "CustomMsg");
        $this->Fields['subcuenta'] = &$this->subcuenta;

        // descripcion
        $this->descripcion = new DbField('cont_plancta', 'cont_plancta', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, 100, -1, false, '`descripcion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // clasificacion
        $this->clasificacion = new DbField('cont_plancta', 'cont_plancta', 'x_clasificacion', 'clasificacion', '`clasificacion`', '`clasificacion`', 202, 7, -1, false, '`clasificacion`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->clasificacion->Lookup = new Lookup('clasificacion', 'cont_plancta', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->clasificacion->OptionCount = 7;
        $this->clasificacion->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->clasificacion->Param, "CustomMsg");
        $this->Fields['clasificacion'] = &$this->clasificacion;

        // naturaleza
        $this->naturaleza = new DbField('cont_plancta', 'cont_plancta', 'x_naturaleza', 'naturaleza', '`naturaleza`', '`naturaleza`', 202, 5, -1, false, '`naturaleza`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->naturaleza->Required = true; // Required field
        $this->naturaleza->Sortable = true; // Allow sort
        $this->naturaleza->Lookup = new Lookup('naturaleza', 'cont_plancta', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->naturaleza->OptionCount = 2;
        $this->naturaleza->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->naturaleza->Param, "CustomMsg");
        $this->Fields['naturaleza'] = &$this->naturaleza;

        // tipo
        $this->tipo = new DbField('cont_plancta', 'cont_plancta', 'x_tipo', 'tipo', '`tipo`', '`tipo`', 202, 9, -1, false, '`tipo`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->tipo->Required = true; // Required field
        $this->tipo->Sortable = true; // Allow sort
        $this->tipo->Lookup = new Lookup('tipo', 'cont_plancta', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // moneda
        $this->moneda = new DbField('cont_plancta', 'cont_plancta', 'x_moneda', 'moneda', '`moneda`', '`moneda`', 200, 6, -1, false, '`moneda`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->moneda->Lookup = new Lookup('moneda', 'parametro', false, 'valor1', ["valor1","","",""], [], [], [], [], [], [], '`valor2` ASC', '');
        $this->moneda->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->moneda->Param, "CustomMsg");
        $this->Fields['moneda'] = &$this->moneda;

        // activa
        $this->activa = new DbField('cont_plancta', 'cont_plancta', 'x_activa', 'activa', '`activa`', '`activa`', 202, 1, -1, false, '`activa`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->activa->Required = true; // Required field
        $this->activa->Sortable = true; // Allow sort
        $this->activa->Lookup = new Lookup('activa', 'cont_plancta', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->activa->OptionCount = 2;
        $this->activa->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->activa->Param, "CustomMsg");
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ContPlanctaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ContPlanctaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ContPlanctaView";
            case Config("API_ADD_ACTION"):
                return "ContPlanctaAdd";
            case Config("API_EDIT_ACTION"):
                return "ContPlanctaEdit";
            case Config("API_DELETE_ACTION"):
                return "ContPlanctaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContPlanctaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ContPlanctaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ContPlanctaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ContPlanctaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ContPlanctaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContPlanctaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ContPlanctaDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // naturaleza
        $this->naturaleza->LinkCustomAttributes = "";
    ...
    public function renderEditRow()
    {
        ...
        // naturaleza
        $this->naturaleza->EditAttrs["class"] = "form-control";
        $this->naturaleza->EditCustomAttributes = "";
        if (strval($this->naturaleza->CurrentValue) != "") {
