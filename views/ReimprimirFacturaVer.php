...
?>
	<form id="frm" name="frm" method="post" action="reportes/factura_fiscal_reportes.php?documento=RI&id=<?php echo $nro_documento; ?>&username=<?php echo CurrentUserName(); ?>">
<div class="container">
  <div class="mb-3 row">
  ...
  <div class="mb-3 row">
	...
	<table class="table table-bordered">
		...
		$sql = "SELECT
				...
				WHERE a.tipo_documento = 'TDCFCV' AND a.id_documento = $id
		...
		?>
			<tr>
				<td class="text-center" colspan="4">
					...
					<input type="submit" class="btn btn-default" type="button" value="Reimprimir Factura">
					&nbsp;
