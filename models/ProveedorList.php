...
class ProveedorList extends Proveedor
{
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->tipo_ret_iva, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->tipo_ret_islr_concepto, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->tipo_ret_mun, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->tipo_impmun, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->cta_bco, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupListOptions()
    {
        ...
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'proveedor_articulo') && !$this->ShowMultipleDetails;
        $item->OnLeft = true;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'proveedor_articulo')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ProveedorArticuloList?" . Config("TABLE_SHOW_MASTER") . "=proveedor&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'adjunto')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("AdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=proveedor&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function renderListOptionsExt()
    {
        ...
        $links = "";
        $btngrps = "";
        $sqlwrk = "`proveedor`=" . AdjustSql($this->id->CurrentValue, $this->Dbid) . "";

        // Column "detail_proveedor_articulo"
        if ($this->DetailPages && $this->DetailPages["proveedor_articulo"] && $this->DetailPages["proveedor_articulo"]->Visible && $Security->allowList(CurrentProjectID() . 'proveedor_articulo')) {
            $link = "";
            $option = $this->ListOptions["detail_proveedor_articulo"];
            $url = "ProveedorArticuloPreview?t=proveedor&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"proveedor_articulo\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'proveedor')) {
                $label = $Language->TablePhrase("proveedor_articulo", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"proveedor_articulo\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ProveedorArticuloList?" . Config("TABLE_SHOW_MASTER") . "=proveedor&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("proveedor_articulo", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        if ($this->DetailPages && $this->DetailPages["adjunto"] && $this->DetailPages["adjunto"]->Visible && $Security->allowList(CurrentProjectID() . 'adjunto')) {
            ...
            $url = "AdjuntoPreview?t=proveedor&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'proveedor')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("AdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=proveedor&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
    ...
    protected function loadSearchValues()
    {
        ...
        // cuenta_auxiliar
        if (!$this->isAddOrEdit() && $this->cuenta_auxiliar->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // cuenta_gasto
        if (!$this->isAddOrEdit() && $this->cuenta_gasto->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipo_ret_iva
        if (!$this->isAddOrEdit() && $this->tipo_ret_iva->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        if (!$this->isAddOrEdit() && $this->tipo_ret_islr_concepto->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipo_ret_islr
        if (!$this->isAddOrEdit() && $this->tipo_ret_islr->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipo_ret_mun
        if (!$this->isAddOrEdit() && $this->tipo_ret_mun->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipo_impmun
        if (!$this->isAddOrEdit() && $this->tipo_impmun->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // cta_bco
        if (!$this->isAddOrEdit() && $this->cta_bco->AdvancedSearch->get()) {
            $hasValue = true;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fproveedorlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fproveedorlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fproveedorlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
