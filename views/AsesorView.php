...
loadjs.ready("head", function () {
    ...
    fasesorview = currentForm = new ew.Form("fasesorview", "view");
    loadjs.done("fasesorview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="fasesorview" id="fasesorview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
