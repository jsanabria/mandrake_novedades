...
class ViewEntradasSalidas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_documento
        $this->id_documento = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_id_documento', 'id_documento', '`id_documento`', '`id_documento`', 19, 10, -1, false, '`id_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // articulo
        $this->articulo = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->articulo->Sortable = true; // Allow sort
        $this->articulo->Lookup = new Lookup('articulo', 'articulo', false, 'id', ["codigo_ims","principio_activo","",""], [], [], [], [], [], [], '', '');
        ...
        // lote
        $this->lote = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_lote', 'lote', '`lote`', '`lote`', 200, 20, -1, false, '`lote`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha_vencimiento
        $this->fecha_vencimiento = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_fecha_vencimiento', 'fecha_vencimiento', '`fecha_vencimiento`', CastDateFieldForLike("`fecha_vencimiento`", 7, "DB"), 133, 10, 7, false, '`fecha_vencimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // almacen
        $this->almacen = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_almacen', 'almacen', '`almacen`', '`almacen`', 200, 6, -1, false, '`almacen`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_articulo
        $this->cantidad_articulo = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_cantidad_articulo', 'cantidad_articulo', '`cantidad_articulo`', '`cantidad_articulo`', 131, 10, -1, false, '`cantidad_articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->articulo_unidad_medida = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_articulo_unidad_medida', 'articulo_unidad_medida', '`articulo_unidad_medida`', '`articulo_unidad_medida`', 200, 6, -1, false, '`articulo_unidad_medida`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->articulo_unidad_medida->Sortable = true; // Allow sort
        $this->articulo_unidad_medida->Lookup = new Lookup('articulo_unidad_medida', 'unidad_medida', false, 'codigo', ["descripcion","","",""], [], [], [], [], [], [], '', '');
        ...
        $this->cantidad_unidad_medida = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_cantidad_unidad_medida', 'cantidad_unidad_medida', '`cantidad_unidad_medida`', '`cantidad_unidad_medida`', 131, 10, -1, false, '`cantidad_unidad_medida`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_movimiento
        $this->cantidad_movimiento = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_cantidad_movimiento', 'cantidad_movimiento', '`cantidad_movimiento`', '`cantidad_movimiento`', 131, 10, -1, false, '`cantidad_movimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // costo_unidad
        $this->costo_unidad = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_costo_unidad', 'costo_unidad', '`costo_unidad`', '`costo_unidad`', 131, 14, -1, false, '`costo_unidad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // costo
        $this->costo = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_costo', 'costo', '`costo`', '`costo`', 131, 14, -1, false, '`costo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio_unidad
        $this->precio_unidad = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_precio_unidad', 'precio_unidad', '`precio_unidad`', '`precio_unidad`', 131, 14, -1, false, '`precio_unidad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio
        $this->precio = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_precio', 'precio', '`precio`', '`precio`', 131, 14, -1, false, '`precio`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_compra
        $this->id_compra = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_id_compra', 'id_compra', '`id_compra`', '`id_compra`', 21, 20, -1, false, '`id_compra`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alicuota
        $this->alicuota = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_alicuota', 'alicuota', '`alicuota`', '`alicuota`', 131, 5, -1, false, '`alicuota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_consignacion
        $this->id_consignacion = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_id_consignacion', 'id_consignacion', '`id_consignacion`', '`id_consignacion`', 21, 20, -1, false, '`id_consignacion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // descuento
        $this->descuento = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_descuento', 'descuento', '`descuento`', '`descuento`', 131, 6, -1, false, '`descuento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->precio_unidad_sin_desc = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_precio_unidad_sin_desc', 'precio_unidad_sin_desc', '`precio_unidad_sin_desc`', '`precio_unidad_sin_desc`', 131, 14, -1, false, '`precio_unidad_sin_desc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // check_ne
        $this->check_ne = new DbField('view_entradas_salidas', 'view_entradas_salidas', 'x_check_ne', 'check_ne', '`check_ne`', '`check_ne`', 202, 1, -1, false, '`check_ne`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->check_ne->Sortable = true; // Allow sort
        $this->check_ne->Lookup = new Lookup('check_ne', 'view_entradas_salidas', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    // Master filter
    public function sqlMasterFilter_view_entradas()
    {
        return "`tipo_documento`='@tipo_documento@' AND `id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_entradas()
    {
        return "`tipo_documento`='@tipo_documento@' AND `id_documento`=@id_documento@";
    }

    // Master filter
    public function sqlMasterFilter_view_salidas()
    {
        return "`tipo_documento`='@tipo_documento@' AND `id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_salidas()
    {
        return "`tipo_documento`='@tipo_documento@' AND `id_documento`=@id_documento@";
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewEntradasSalidasView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewEntradasSalidasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewEntradasSalidasAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewEntradasSalidasView";
            case Config("API_ADD_ACTION"):
                return "ViewEntradasSalidasAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewEntradasSalidasEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewEntradasSalidasDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewEntradasSalidasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewEntradasSalidasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewEntradasSalidasAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ViewEntradasSalidasEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewEntradasSalidasAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewEntradasSalidasDelete", $this->getUrlParm());
    }
