...
class ViewFacturasVencidas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codcli
        $this->codcli = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_codcli', 'codcli', '`codcli`', '`codcli`', 3, 11, -1, false, '`codcli`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->codcli->Sortable = true; // Allow sort
        ...
        $this->codcli->Lookup = new Lookup('codcli', 'cliente', false, 'id', ["nombre","","",""], [], [], [], [], [], [], '`nombre` ASC', '');
        $this->codcli->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->codcli->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->codcli->Param, "CustomMsg");
        $this->Fields['codcli'] = &$this->codcli;

        // cliente
        $this->cliente = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_cliente', 'cliente', '`cliente`', '`cliente`', 200, 80, -1, false, '`cliente`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha
        $this->fecha = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 135, 19, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nro_documento
        $this->nro_documento = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_nro_documento', 'nro_documento', '`nro_documento`', '`nro_documento`', 200, 20, -1, false, '`nro_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // total
        $this->total = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_total', 'total', '`total`', '`total`', 131, 14, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha_entrega
        $this->fecha_entrega = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_fecha_entrega', 'fecha_entrega', '`fecha_entrega`', CastDateFieldForLike("`fecha_entrega`", 7, "DB"), 133, 10, 7, false, '`fecha_entrega`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dias_credito
        $this->dias_credito = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_dias_credito', 'dias_credito', '`dias_credito`', '`dias_credito`', 16, 4, -1, false, '`dias_credito`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dias_vencidos
        $this->dias_vencidos = new DbField('view_facturas_vencidas', 'view_facturas_vencidas', 'x_dias_vencidos', 'dias_vencidos', '`dias_vencidos`', '`dias_vencidos`', 20, 22, -1, false, '`dias_vencidos`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->dias_vencidos->Sortable = true; // Allow sort
        $this->dias_vencidos->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->dias_vencidos->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->dias_vencidos->Param, "CustomMsg");
    ...
    {
        global $Language;
        if ($pageName == "ViewFacturasVencidasView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewFacturasVencidasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewFacturasVencidasAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewFacturasVencidasView";
            case Config("API_ADD_ACTION"):
                return "ViewFacturasVencidasAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewFacturasVencidasEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewFacturasVencidasDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFacturasVencidasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewFacturasVencidasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewFacturasVencidasAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewFacturasVencidasDelete", $this->getUrlParm());
    }
