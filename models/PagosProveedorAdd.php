...
class PagosProveedorAdd extends PagosProveedor
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->monto_dado->CurrentValue = null;
        $this->monto_dado->OldValue = $this->monto_dado->CurrentValue;
        ...
        $this->cont_lotes->CurrentValue = null;
        $this->cont_lotes->OldValue = $this->cont_lotes->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->monto_dado->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->monto_dado->setFormValue($val);
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['monto_dado'] = $this->monto_dado->CurrentValue;
        ...
        $row['cont_lotes'] = $this->cont_lotes->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->monto_dado->EditValue = HtmlEncode($this->monto_dado->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // banco
        $this->banco->setDbValueDef($rsnew, $this->banco->CurrentValue, 0, false);
        ...
        // monto_dado
        $this->monto_dado->setDbValueDef($rsnew, $this->monto_dado->CurrentValue, null, false);
