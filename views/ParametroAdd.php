...
loadjs.ready("head", function () {
    ...
    fparametroadd = currentForm = new ew.Form("fparametroadd", "add");
    ...
    // Validate form
    fparametroadd.validate = function () {
    ...
    // Form_CustomValidate
    fparametroadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fparametroadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fparametroadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fparametroadd" id="fparametroadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
