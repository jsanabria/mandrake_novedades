...
loadjs.ready("head", function () {
    ...
    fpagosadd = currentForm = new ew.Form("fpagosadd", "add");
    ...
    // Form_CustomValidate
    fpagosadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpagosadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpagosadd.lists.tipo_pago = <?= $Page->tipo_pago->toClientList($Page) ?>;
    loadjs.done("fpagosadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpagosadd" id="fpagosadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpagosadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpagosadd", "x_fecha", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
