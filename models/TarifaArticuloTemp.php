...
class TarifaArticuloTemp extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('tarifa_articulo_temp', 'tarifa_articulo_temp', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tarifa
        $this->tarifa = new DbField('tarifa_articulo_temp', 'tarifa_articulo_temp', 'x_tarifa', 'tarifa', '`tarifa`', '`tarifa`', 19, 10, -1, false, '`tarifa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('tarifa_articulo_temp', 'tarifa_articulo_temp', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // articulo
        $this->articulo = new DbField('tarifa_articulo_temp', 'tarifa_articulo_temp', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio
        $this->precio = new DbField('tarifa_articulo_temp', 'tarifa_articulo_temp', 'x_precio', 'precio', '`precio`', '`precio`', 131, 13, -1, false, '`precio`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "TarifaArticuloTempView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifaArticuloTempEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifaArticuloTempAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TarifaArticuloTempView";
            case Config("API_ADD_ACTION"):
                return "TarifaArticuloTempAdd";
            case Config("API_EDIT_ACTION"):
                return "TarifaArticuloTempEdit";
            case Config("API_DELETE_ACTION"):
                return "TarifaArticuloTempDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaArticuloTempView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifaArticuloTempView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifaArticuloTempAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifaArticuloTempDelete", $this->getUrlParm());
    }
