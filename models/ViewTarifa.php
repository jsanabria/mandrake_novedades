...
class ViewTarifa extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // articulo
        $this->articulo = new DbField('view_tarifa', 'view_tarifa', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio
        $this->precio = new DbField('view_tarifa', 'view_tarifa', 'x_precio', 'precio', '`precio`', '`precio`', 131, 13, -1, false, '`precio`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tarifa
        $this->tarifa = new DbField('view_tarifa', 'view_tarifa', 'x_tarifa', 'tarifa', '`tarifa`', '`tarifa`', 200, 50, -1, false, '`tarifa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ViewTarifaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewTarifaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewTarifaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTarifaView";
            case Config("API_ADD_ACTION"):
                return "ViewTarifaAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewTarifaEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewTarifaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTarifaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewTarifaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewTarifaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewTarifaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewTarifaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTarifaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewTarifaDelete", $this->getUrlParm());
    }
