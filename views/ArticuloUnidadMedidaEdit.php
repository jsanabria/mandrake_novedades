...
loadjs.ready("head", function () {
    ...
    farticulo_unidad_medidaedit = currentForm = new ew.Form("farticulo_unidad_medidaedit", "edit");
    ...
    farticulo_unidad_medidaedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = farticulo_unidad_medidaedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    farticulo_unidad_medidaedit.validate = function () {
    ...
    // Form_CustomValidate
    farticulo_unidad_medidaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    farticulo_unidad_medidaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    farticulo_unidad_medidaedit.lists.unidad_medida = <?= $Page->unidad_medida->toClientList($Page) ?>;
    loadjs.done("farticulo_unidad_medidaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="farticulo_unidad_medidaedit" id="farticulo_unidad_medidaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
