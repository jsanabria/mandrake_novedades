...
loadjs.ready("head", function () {
    ...
    fusuarioadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fusuarioadd.lists.userlevelid = <?= $Page->userlevelid->toClientList($Page) ?>;
    fusuarioadd.lists.asesor = <?= $Page->asesor->toClientList($Page) ?>;
    fusuarioadd.lists.cliente = <?= $Page->cliente->toClientList($Page) ?>;
    fusuarioadd.lists.proveedor = <?= $Page->proveedor->toClientList($Page) ?>;
    fusuarioadd.lists.activo = <?= $Page->activo->toClientList($Page) ?>;
...
<input type="<?= $Page->_username->getInputTextType() ?>" data-table="usuario" data-field="x__username" name="x__username" id="x__username" size="30" maxlength="30" placeholder="<?= HtmlEncode($Page->_username->getPlaceHolder()) ?>" value="<?= $Page->_username->EditValue ?>"<?= $Page->_username->editAttributes() ?> aria-describedby="x__username_help">
...
<div class="input-group">
    <input type="password" name="x__password" id="x__password" autocomplete="new-password" data-field="x__password" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->_password->getPlaceHolder()) ?>"<?= $Page->_password->editAttributes() ?> aria-describedby="x__password_help">
