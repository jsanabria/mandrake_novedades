...
class AbonoEdit extends Abono
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->cliente->ViewValue = FormatNumber($this->cliente->ViewValue, 0, -2, -2, -2);
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // nro_recibo
            $this->nro_recibo->setDbValueDef($rsnew, $this->nro_recibo->CurrentValue, 0, $this->nro_recibo->ReadOnly);
