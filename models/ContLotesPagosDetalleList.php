...
class ContLotesPagosDetalleList extends ContLotesPagosDetalle
{
    ...
    // Table name
    public $TableName = 'cont_lotes_pagos_detalle';
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["cont_lotes_pagos_detalle"]) || get_class($GLOBALS["cont_lotes_pagos_detalle"]) == PROJECT_NAMESPACE . "cont_lotes_pagos_detalle") {
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fcont_lotes_pagos_detallelistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("cont_lotes_pagos_detalle"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "cont_lotes_pagos") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fcont_lotes_pagos_detallelistsrch", $filters);
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->cont_lotes_pago, $default, false); // cont_lotes_pago
        ...
        $this->buildSearchSql($where, $this->tipodoc, $default, false); // tipodoc
        $this->buildSearchSql($where, $this->nro_documento, $default, false); // nro_documento
        $this->buildSearchSql($where, $this->monto_a_pagar, $default, false); // monto_a_pagar
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->cont_lotes_pago->AdvancedSearch->save(); // cont_lotes_pago
            ...
            $this->monto_a_pagar->AdvancedSearch->save(); // monto_a_pagar
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->tipodoc, $arKeywords, $type);
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->cont_lotes_pago->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->monto_a_pagar->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->cont_lotes_pago->AdvancedSearch->unsetSession();
                ...
                $this->monto_a_pagar->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->cont_lotes_pago->AdvancedSearch->load();
                ...
                $this->monto_a_pagar->AdvancedSearch->load();
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`proveedor` ASC,`Id` ASC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->proveedor->getSort() != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.fcont_lotes_pagos_detallelist, url:'" . GetUrl($this->MultiDeleteUrl) . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
        $item->Visible = $Security->canDelete();
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcont_lotes_pagos_detallelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcont_lotes_pagos_detallelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fcont_lotes_pagos_detallelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cont_lotes_pago->CurrentValue = null;
        $this->cont_lotes_pago->OldValue = $this->cont_lotes_pago->CurrentValue;
        ...
        $this->monto_a_pagar->CurrentValue = null;
        $this->monto_a_pagar->OldValue = $this->monto_a_pagar->CurrentValue;
        $this->monto_pagado->CurrentValue = null;
        $this->monto_pagado->OldValue = $this->monto_pagado->CurrentValue;
    ...
    protected function loadSearchValues()
    {
        ...
        // cont_lotes_pago
        if (!$this->isAddOrEdit() && $this->cont_lotes_pago->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->cont_lotes_pago->AdvancedSearch->SearchValue != "" || $this->cont_lotes_pago->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // id_documento
        if (!$this->isAddOrEdit() && $this->id_documento->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // tipodoc
        if (!$this->isAddOrEdit() && $this->tipodoc->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->tipodoc->AdvancedSearch->SearchValue != "" || $this->tipodoc->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // monto_a_pagar
        if (!$this->isAddOrEdit() && $this->monto_a_pagar->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->monto_a_pagar->AdvancedSearch->SearchValue != "" || $this->monto_a_pagar->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // monto_pagado
        if (!$this->isAddOrEdit() && $this->monto_pagado->AdvancedSearch->get()) {
            $hasValue = true;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->monto_a_pagar->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->monto_a_pagar->setFormValue($val);
            }
        }
        ...
        if (!$this->monto_pagado->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->monto_pagado->setFormValue($val);
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['cont_lotes_pago'] = $this->cont_lotes_pago->CurrentValue;
        ...
        $row['tipodoc'] = $this->tipodoc->CurrentValue;
        $row['nro_documento'] = $this->nro_documento->CurrentValue;
        $row['monto_a_pagar'] = $this->monto_a_pagar->CurrentValue;
        $row['monto_pagado'] = $this->monto_pagado->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->monto_a_pagar->FormValue == $this->monto_a_pagar->CurrentValue && is_numeric(ConvertToFloatString($this->monto_a_pagar->CurrentValue))) {
            $this->monto_a_pagar->CurrentValue = ConvertToFloatString($this->monto_a_pagar->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->monto_pagado->FormValue == $this->monto_pagado->CurrentValue && is_numeric(ConvertToFloatString($this->monto_pagado->CurrentValue))) {
            $this->monto_pagado->CurrentValue = ConvertToFloatString($this->monto_pagado->CurrentValue);
        }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->proveedor->EditValue = HtmlEncode($this->proveedor->CurrentValue);
            ...
            $this->tipodoc->EditValue = $this->tipodoc->options(true);
            ...
            $this->monto_a_pagar->EditValue = HtmlEncode($this->monto_a_pagar->CurrentValue);
            ...
            if (strval($this->monto_a_pagar->EditValue) != "" && is_numeric($this->monto_a_pagar->EditValue)) {
                $this->monto_a_pagar->EditValue = FormatNumber($this->monto_a_pagar->EditValue, -2, -1, -2, -1);
            }

            // monto_pagado
            $this->monto_pagado->EditAttrs["class"] = "form-control";
            $this->monto_pagado->EditCustomAttributes = "";
            $this->monto_pagado->EditValue = HtmlEncode($this->monto_pagado->CurrentValue);
            ...
            if (strval($this->monto_pagado->EditValue) != "" && is_numeric($this->monto_pagado->EditValue)) {
                $this->monto_pagado->EditValue = FormatNumber($this->monto_pagado->EditValue, -2, -1, -2, -1);
            }
            ...
            $this->monto_a_pagar->EditAttrs["class"] = "form-control";
            $this->monto_a_pagar->EditCustomAttributes = "";
            $this->monto_a_pagar->EditValue = HtmlEncode($this->monto_a_pagar->AdvancedSearch->SearchValue);
            $this->monto_a_pagar->PlaceHolder = RemoveHtml($this->monto_a_pagar->caption());

            // monto_pagado
            $this->monto_pagado->EditAttrs["class"] = "form-control";
            $this->monto_pagado->EditCustomAttributes = "";
            $this->monto_pagado->EditValue = HtmlEncode($this->monto_pagado->AdvancedSearch->SearchValue);
            $this->monto_pagado->PlaceHolder = RemoveHtml($this->monto_pagado->caption());
    ...
    protected function validateForm()
    {
        ...
        if ($this->monto_a_pagar->Required) {
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['saldo']); // saldo
        return md5($hash);
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // monto_a_pagar
        $this->monto_a_pagar->setDbValueDef($rsnew, $this->monto_a_pagar->CurrentValue, null, false);

        // monto_pagado
        $this->monto_pagado->setDbValueDef($rsnew, $this->monto_pagado->CurrentValue, null, false);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fcont_lotes_pagos_detallelist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fcont_lotes_pagos_detallelist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fcont_lotes_pagos_detallelist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_cont_lotes_pagos_detalle" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_cont_lotes_pagos_detalle\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fcont_lotes_pagos_detallelist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fcont_lotes_pagos_detallelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    protected function setupMasterParms()
    {
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "cont_lotes_pagos") {
                ...
                if (($parm = Get("fk_id", Get("cont_lotes_pago"))) !== null) {
                    ...
                    $this->cont_lotes_pago->setQueryStringValue($masterTbl->id->QueryStringValue);
            ...
            if ($masterTblVar == "cont_lotes_pagos") {
                ...
                if (($parm = Post("fk_id", Post("cont_lotes_pago"))) !== null) {
                    ...
                    $this->cont_lotes_pago->setFormValue($masterTbl->id->FormValue);
        ...
        if ($validMaster) {
            ...
            if ($masterTblVar != "cont_lotes_pagos") {
                if ($this->cont_lotes_pago->CurrentValue == "") {
                    $this->cont_lotes_pago->setSessionValue("");
                }
            }
        }
    ...
    {
        // Example:
        $id = isset($_GET["fk_id"]) ? $_GET["fk_id"] : $this->cont_lotes_pago->CurrentValue;
        $header = '<a href="include/paymul_listar.php?id=' . $id . '" class="btn btn-primary" id="paymul" name="paymul">Exportar PAYMUL</a>';
        $header .= '&nbsp;<a target="_blank" href="reportes/recibo_de_pago.php?id=' . $id . '" class="btn btn-primary" id="reporte" name="reporte">Imprimir Recibo</a>';
    }
