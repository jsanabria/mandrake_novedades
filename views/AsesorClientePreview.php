...
<div class="card ew-grid asesor_cliente"><!-- .card -->
...
<?php if ($Page->cliente->Visible) { // cliente ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->cliente->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->cliente->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->cliente->getNextSort() ?>">
