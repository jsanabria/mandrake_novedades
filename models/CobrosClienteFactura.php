...
class CobrosClienteFactura extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // cobros_cliente
        $this->cobros_cliente = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_cobros_cliente', 'cobros_cliente', '`cobros_cliente`', '`cobros_cliente`', 19, 10, -1, false, '`cobros_cliente`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_documento
        $this->id_documento = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_id_documento', 'id_documento', '`id_documento`', '`id_documento`', 19, 10, -1, false, '`id_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // abono
        $this->abono = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_abono', 'abono', '`abono`', '`abono`', 202, 1, -1, false, '`abono`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->abono->Sortable = true; // Allow sort
        $this->abono->Lookup = new Lookup('abono', 'cobros_cliente_factura', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // monto
        $this->monto = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_monto', 'monto', '`monto`', '`monto`', 131, 14, -1, false, '`monto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retivamonto
        $this->retivamonto = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_retivamonto', 'retivamonto', '`retivamonto`', '`retivamonto`', 131, 14, -1, false, '`retivamonto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->retivamonto->Sortable = true; // Allow sort
        $this->retivamonto->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // retiva
        $this->retiva = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_retiva', 'retiva', '`retiva`', '`retiva`', 200, 15, -1, false, '`retiva`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // retislrmonto
        $this->retislrmonto = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_retislrmonto', 'retislrmonto', '`retislrmonto`', '`retislrmonto`', 131, 14, -1, false, '`retislrmonto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->retislrmonto->Sortable = true; // Allow sort
        $this->retislrmonto->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // retislr
        $this->retislr = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_retislr', 'retislr', '`retislr`', '`retislr`', 200, 15, -1, false, '`retislr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // comprobante
        $this->comprobante = new DbField('cobros_cliente_factura', 'cobros_cliente_factura', 'x_comprobante', 'comprobante', '`comprobante`', '`comprobante`', 3, 11, -1, false, '`comprobante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "CobrosClienteFacturaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CobrosClienteFacturaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CobrosClienteFacturaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CobrosClienteFacturaView";
            case Config("API_ADD_ACTION"):
                return "CobrosClienteFacturaAdd";
            case Config("API_EDIT_ACTION"):
                return "CobrosClienteFacturaEdit";
            case Config("API_DELETE_ACTION"):
                return "CobrosClienteFacturaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CobrosClienteFacturaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CobrosClienteFacturaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CobrosClienteFacturaAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("CobrosClienteFacturaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CobrosClienteFacturaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CobrosClienteFacturaDelete", $this->getUrlParm());
    }
