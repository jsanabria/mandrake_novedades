 ...
 * Page class
 */
class ContLotesPagosEdit extends ContLotesPagos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosEdit";
    ...
    public function run()
    {
        ...
        $this->banco->Required = false;
        $this->referencia->Required = false;
    ...
    protected function validateForm()
    {
        ...
        if ($this->procesado->Required) {
            if (!$this->procesado->IsDetailKey && EmptyValue($this->procesado->FormValue)) {
        ...
        if (in_array("cont_lotes_pagos_detalle", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // procesado
            $this->procesado->setDbValueDef($rsnew, $this->procesado->CurrentValue, null, $this->procesado->ReadOnly);
