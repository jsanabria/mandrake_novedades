...
class EntradasSalidasDelete extends EntradasSalidas
{
    ...
    {
        // Example:
        if(trim(Page("entradas_salidas")->id_documento->CurrentValue) == "") { 
        	$url = "Home";
        }
        $tipo = Page("entradas_salidas")->tipo_documento->CurrentValue;
       	if($tipo == "TDCNRP") { 
       		$id = Page("entradas_salidas")->id_documento->CurrentValue;
