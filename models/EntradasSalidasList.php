...
class EntradasSalidasList extends EntradasSalidas
{
    ...
    public function __construct()
    {
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fentradas_salidaslistsrch";
    ...
    public function run()
    {
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "entradas") {
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_precio_unidad_sin_desc") && $CurrentForm->hasValue("o_precio_unidad_sin_desc") && $this->precio_unidad_sin_desc->CurrentValue != $this->precio_unidad_sin_desc->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_descuento") && $CurrentForm->hasValue("o_descuento") && $this->descuento->CurrentValue != $this->descuento->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_costo_unidad") && $CurrentForm->hasValue("o_costo_unidad") && $this->costo_unidad->CurrentValue != $this->costo_unidad->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_costo") && $CurrentForm->hasValue("o_costo") && $this->costo->CurrentValue != $this->costo->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_precio_unidad") && $CurrentForm->hasValue("o_precio_unidad") && $this->precio_unidad->CurrentValue != $this->precio_unidad->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->precio_unidad_sin_desc->clearErrorMessage();
        $this->descuento->clearErrorMessage();
        $this->costo_unidad->clearErrorMessage();
        $this->costo->clearErrorMessage();
        $this->precio_unidad->clearErrorMessage();
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->pivote3x2->AdvancedSearch->toJson(), ","); // Field pivote3x2
        $filterList = Concat($filterList, $this->pivote3x2_2->AdvancedSearch->toJson(), ","); // Field pivote3x2_2
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fentradas_salidaslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field pivote3x2
        $this->pivote3x2->AdvancedSearch->SearchValue = @$filter["x_pivote3x2"];
        $this->pivote3x2->AdvancedSearch->SearchOperator = @$filter["z_pivote3x2"];
        $this->pivote3x2->AdvancedSearch->SearchCondition = @$filter["v_pivote3x2"];
        $this->pivote3x2->AdvancedSearch->SearchValue2 = @$filter["y_pivote3x2"];
        $this->pivote3x2->AdvancedSearch->SearchOperator2 = @$filter["w_pivote3x2"];
        $this->pivote3x2->AdvancedSearch->save();

        // Field pivote3x2_2
        $this->pivote3x2_2->AdvancedSearch->SearchValue = @$filter["x_pivote3x2_2"];
        $this->pivote3x2_2->AdvancedSearch->SearchOperator = @$filter["z_pivote3x2_2"];
        $this->pivote3x2_2->AdvancedSearch->SearchCondition = @$filter["v_pivote3x2_2"];
        $this->pivote3x2_2->AdvancedSearch->SearchValue2 = @$filter["y_pivote3x2_2"];
        $this->pivote3x2_2->AdvancedSearch->SearchOperator2 = @$filter["w_pivote3x2_2"];
        $this->pivote3x2_2->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->almacen, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->articulo_unidad_medida, $arKeywords, $type);
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`lote` ASC,`articulo` ASC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->lote->getSort() != "") {
                    $useDefaultSort = false;
                }
                if ($this->articulo->getSort() != "") {
                    $useDefaultSort = false;
                }
                if ($useDefaultSort) {
                    $this->lote->setSort("ASC");
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->lote->setSort("");
                $this->pivote3x2->setSort("");
                $this->pivote3x2_2->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fentradas_salidaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fentradas_salidaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
            ...
            foreach ($this->ListActions->Items as $listaction) {
                if ($listaction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fentradas_salidaslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->precio_unidad_sin_desc->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->precio_unidad_sin_desc->setFormValue($val);
            }
        }
    ...
    public function renderRow()
    {
        ...
        // Convert decimal values if posted back
        if ($this->precio_unidad_sin_desc->FormValue == $this->precio_unidad_sin_desc->CurrentValue && is_numeric(ConvertToFloatString($this->precio_unidad_sin_desc->CurrentValue))) {
            $this->precio_unidad_sin_desc->CurrentValue = ConvertToFloatString($this->precio_unidad_sin_desc->CurrentValue);
        }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->precio_unidad_sin_desc->EditValue = HtmlEncode($this->precio_unidad_sin_desc->CurrentValue);
            ...
            if (strval($this->precio_unidad_sin_desc->EditValue) != "" && is_numeric($this->precio_unidad_sin_desc->EditValue)) {
                ...
                $this->precio_unidad_sin_desc->OldValue = $this->precio_unidad_sin_desc->EditValue;
            }
            ...
            if (strval($this->costo_unidad->EditValue) != "" && is_numeric($this->costo_unidad->EditValue)) {
                ...
                $this->costo_unidad->OldValue = $this->costo_unidad->EditValue;
            }
            ...
            if (strval($this->precio_unidad->EditValue) != "" && is_numeric($this->precio_unidad->EditValue)) {
                ...
                $this->precio_unidad->OldValue = $this->precio_unidad->EditValue;
            }
    ...
    protected function validateForm()
    {
        ...
        if ($this->precio_unidad_sin_desc->Required) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // precio_unidad_sin_desc
            $this->precio_unidad_sin_desc->setDbValueDef($rsnew, $this->precio_unidad_sin_desc->CurrentValue, null, $this->precio_unidad_sin_desc->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // precio_unidad_sin_desc
        $this->precio_unidad_sin_desc->setDbValueDef($rsnew, $this->precio_unidad_sin_desc->CurrentValue, null, false);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fentradas_salidaslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fentradas_salidaslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fentradas_salidaslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_entradas_salidas" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_entradas_salidas\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fentradas_salidaslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fentradas_salidaslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($return = false)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "entradas") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->Table = $entradas;
                    $entradas->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
        ...
        // Export master record
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "salidas") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->Table = $salidas;
                    $salidas->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
                $doc->setStyle($exportStyle); // Restore
