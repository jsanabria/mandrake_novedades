 ...
 * Page class
 */
class PuntosDelete extends Puntos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PuntosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PuntosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PuntosList"); // Return to list
                return;
            }
        }
