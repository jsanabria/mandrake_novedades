...
class PagosProveedorFacturaGrid extends PagosProveedorFactura
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->pagos_proveedor->CurrentValue = null;
        $this->pagos_proveedor->OldValue = $this->pagos_proveedor->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['pagos_proveedor'] = $this->pagos_proveedor->CurrentValue;
