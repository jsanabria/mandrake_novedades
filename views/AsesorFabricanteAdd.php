...
loadjs.ready("head", function () {
    ...
    fasesor_fabricanteadd = currentForm = new ew.Form("fasesor_fabricanteadd", "add");
    ...
    fasesor_fabricanteadd.addFields([
    ...
    // Validate form
    fasesor_fabricanteadd.validate = function () {
    ...
    // Form_CustomValidate
    fasesor_fabricanteadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fasesor_fabricanteadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fasesor_fabricanteadd.lists.fabricante = <?= $Page->fabricante->toClientList($Page) ?>;
    loadjs.done("fasesor_fabricanteadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fasesor_fabricanteadd" id="fasesor_fabricanteadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
