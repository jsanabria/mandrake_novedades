...
class UnidadMedida extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('unidad_medida', 'unidad_medida', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // codigo
        $this->codigo = new DbField('unidad_medida', 'unidad_medida', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 6, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // descripcion
        $this->descripcion = new DbField('unidad_medida', 'unidad_medida', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, 20, -1, false, '`descripcion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tipo
        $this->tipo = new DbField('unidad_medida', 'unidad_medida', 'x_tipo', 'tipo', '`tipo`', '`tipo`', 202, 1, -1, false, '`tipo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->tipo->Lookup = new Lookup('tipo', 'unidad_medida', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // cantidad
        $this->cantidad = new DbField('unidad_medida', 'unidad_medida', 'x_cantidad', 'cantidad', '`cantidad`', '`cantidad`', 131, 10, -1, false, '`cantidad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->cantidad->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->cantidad->Param, "CustomMsg");
    ...
    {
        global $Language;
        if ($pageName == "UnidadMedidaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "UnidadMedidaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UnidadMedidaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "UnidadMedidaAdd";
            case Config("API_EDIT_ACTION"):
                return "UnidadMedidaEdit";
            case Config("API_DELETE_ACTION"):
                return "UnidadMedidaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UnidadMedidaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UnidadMedidaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UnidadMedidaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UnidadMedidaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UnidadMedidaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UnidadMedidaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UnidadMedidaDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->cantidad->EditValue) != "" && is_numeric($this->cantidad->EditValue)) {
            $this->cantidad->EditValue = FormatNumber($this->cantidad->EditValue, -2, -1, -2, 0);
        }
