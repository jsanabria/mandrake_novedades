...
class TempConsignacion extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('temp_consignacion', 'temp_consignacion', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // username
        $this->_username = new DbField('temp_consignacion', 'temp_consignacion', 'x__username', 'username', '`username`', '`username`', 200, 30, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nro_documento
        $this->nro_documento = new DbField('temp_consignacion', 'temp_consignacion', 'x_nro_documento', 'nro_documento', '`nro_documento`', '`nro_documento`', 200, 20, -1, false, '`nro_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_documento
        $this->id_documento = new DbField('temp_consignacion', 'temp_consignacion', 'x_id_documento', 'id_documento', '`id_documento`', '`id_documento`', 19, 10, -1, false, '`id_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tipo_documento
        $this->tipo_documento = new DbField('temp_consignacion', 'temp_consignacion', 'x_tipo_documento', 'tipo_documento', '`tipo_documento`', '`tipo_documento`', 200, 6, -1, false, '`tipo_documento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fabricante
        $this->fabricante = new DbField('temp_consignacion', 'temp_consignacion', 'x_fabricante', 'fabricante', '`fabricante`', '`fabricante`', 19, 10, -1, false, '`fabricante`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // articulo
        $this->articulo = new DbField('temp_consignacion', 'temp_consignacion', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_movimiento
        $this->cantidad_movimiento = new DbField('temp_consignacion', 'temp_consignacion', 'x_cantidad_movimiento', 'cantidad_movimiento', '`cantidad_movimiento`', '`cantidad_movimiento`', 131, 10, -1, false, '`cantidad_movimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->cantidad_entre_fechas = new DbField('temp_consignacion', 'temp_consignacion', 'x_cantidad_entre_fechas', 'cantidad_entre_fechas', '`cantidad_entre_fechas`', '`cantidad_entre_fechas`', 131, 10, -1, false, '`cantidad_entre_fechas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->cantidad_entre_fechas->Sortable = true; // Allow sort
        $this->cantidad_entre_fechas->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_entre_fechas->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->cantidad_entre_fechas->Param, "CustomMsg");
        $this->Fields['cantidad_entre_fechas'] = &$this->cantidad_entre_fechas;

        // cantidad_acumulada
        $this->cantidad_acumulada = new DbField('temp_consignacion', 'temp_consignacion', 'x_cantidad_acumulada', 'cantidad_acumulada', '`cantidad_acumulada`', '`cantidad_acumulada`', 131, 10, -1, false, '`cantidad_acumulada`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->cantidad_acumulada->Sortable = true; // Allow sort
        $this->cantidad_acumulada->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_acumulada->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->cantidad_acumulada->Param, "CustomMsg");
        $this->Fields['cantidad_acumulada'] = &$this->cantidad_acumulada;

        // cantidad_ajuste
        $this->cantidad_ajuste = new DbField('temp_consignacion', 'temp_consignacion', 'x_cantidad_ajuste', 'cantidad_ajuste', '`cantidad_ajuste`', '`cantidad_ajuste`', 131, 10, -1, false, '`cantidad_ajuste`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->cantidad_ajuste->Sortable = true; // Allow sort
        $this->cantidad_ajuste->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_ajuste->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->cantidad_ajuste->Param, "CustomMsg");
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "TempConsignacionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TempConsignacionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TempConsignacionView";
            case Config("API_ADD_ACTION"):
                return "TempConsignacionAdd";
            case Config("API_EDIT_ACTION"):
                return "TempConsignacionEdit";
            case Config("API_DELETE_ACTION"):
                return "TempConsignacionDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TempConsignacionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TempConsignacionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TempConsignacionAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("TempConsignacionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TempConsignacionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TempConsignacionDelete", $this->getUrlParm());
    }
