...
class CobrosClienteFacturaGrid extends CobrosClienteFactura
{
    ...
    // Table name
    public $TableName = 'cobros_cliente_factura';
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["cobros_cliente_factura"]) || get_class($GLOBALS["cobros_cliente_factura"]) == PROJECT_NAMESPACE . "cobros_cliente_factura") {
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("cobros_cliente_factura"));
                $doc->Text = @$content;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_tipo_documento") && $CurrentForm->hasValue("o_tipo_documento") && $this->tipo_documento->CurrentValue != $this->tipo_documento->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_abono") && $CurrentForm->hasValue("o_abono") && $this->abono->CurrentValue != $this->abono->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_monto") && $CurrentForm->hasValue("o_monto") && $this->monto->CurrentValue != $this->monto->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_retivamonto") && $CurrentForm->hasValue("o_retivamonto") && $this->retivamonto->CurrentValue != $this->retivamonto->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_retiva") && $CurrentForm->hasValue("o_retiva") && $this->retiva->CurrentValue != $this->retiva->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_retislrmonto") && $CurrentForm->hasValue("o_retislrmonto") && $this->retislrmonto->CurrentValue != $this->retislrmonto->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_retislr") && $CurrentForm->hasValue("o_retislr") && $this->retislr->CurrentValue != $this->retislr->OldValue) {
            return false;
        }
    ...
    {
        $this->tipo_documento->clearErrorMessage();
        $this->abono->clearErrorMessage();
        $this->monto->clearErrorMessage();
        $this->retivamonto->clearErrorMessage();
        $this->retiva->clearErrorMessage();
        $this->retislrmonto->clearErrorMessage();
        $this->retislr->clearErrorMessage();
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cobros_cliente->CurrentValue = null;
        $this->cobros_cliente->OldValue = $this->cobros_cliente->CurrentValue;
        ...
        $this->abono->CurrentValue = "N";
        $this->abono->OldValue = $this->abono->CurrentValue;
        $this->monto->CurrentValue = null;
        $this->monto->OldValue = $this->monto->CurrentValue;
        $this->retivamonto->CurrentValue = null;
        $this->retivamonto->OldValue = $this->retivamonto->CurrentValue;
        $this->retiva->CurrentValue = null;
        $this->retiva->OldValue = $this->retiva->CurrentValue;
        $this->retislrmonto->CurrentValue = null;
        $this->retislrmonto->OldValue = $this->retislrmonto->CurrentValue;
        $this->retislr->CurrentValue = null;
        $this->retislr->OldValue = $this->retislr->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['cobros_cliente'] = $this->cobros_cliente->CurrentValue;
        ...
        $row['retivamonto'] = $this->retivamonto->CurrentValue;
        $row['retiva'] = $this->retiva->CurrentValue;
        $row['retislrmonto'] = $this->retislrmonto->CurrentValue;
        $row['retislr'] = $this->retislr->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        // Convert decimal values if posted back
        if ($this->retivamonto->FormValue == $this->retivamonto->CurrentValue && is_numeric(ConvertToFloatString($this->retivamonto->CurrentValue))) {
            $this->retivamonto->CurrentValue = ConvertToFloatString($this->retivamonto->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->retislrmonto->FormValue == $this->retislrmonto->CurrentValue && is_numeric(ConvertToFloatString($this->retislrmonto->CurrentValue))) {
            $this->retislrmonto->CurrentValue = ConvertToFloatString($this->retislrmonto->CurrentValue);
        }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->retivamonto->ViewValue = FormatNumber($this->retivamonto->ViewValue, 2, -1, -1, -1);
            ...
            $this->retislrmonto->ViewValue = FormatNumber($this->retislrmonto->ViewValue, 2, -1, -1, -1);
            ...
            if (!EmptyValue($this->comprobante->CurrentValue)) {
                $this->comprobante->HrefValue = "cont_asientolist.php?showmaster=cont_comprobante&fk_id=" . $this->comprobante->CurrentValue; // Add prefix/suffix
            ...
            $this->retivamonto->EditValue = HtmlEncode($this->retivamonto->CurrentValue);
            ...
            if (strval($this->retivamonto->EditValue) != "" && is_numeric($this->retivamonto->EditValue)) {
                $this->retivamonto->EditValue = FormatNumber($this->retivamonto->EditValue, -2, -1, -2, -1);
                $this->retivamonto->OldValue = $this->retivamonto->EditValue;
            }
            ...
            $this->retislrmonto->EditValue = HtmlEncode($this->retislrmonto->CurrentValue);
            ...
            if (strval($this->retislrmonto->EditValue) != "" && is_numeric($this->retislrmonto->EditValue)) {
                $this->retislrmonto->EditValue = FormatNumber($this->retislrmonto->EditValue, -2, -1, -2, -1);
                $this->retislrmonto->OldValue = $this->retislrmonto->EditValue;
            }
            ...
            $this->monto->EditValue = FormatNumber($this->monto->EditValue, 2, -1, -1, -1);
            $this->monto->ViewCustomAttributes = "";
            ...
            $this->retivamonto->EditValue = FormatNumber($this->retivamonto->EditValue, 2, -1, -1, -1);
            $this->retivamonto->ViewCustomAttributes = "";
            ...
            $this->retislrmonto->EditValue = FormatNumber($this->retislrmonto->EditValue, 2, -1, -1, -1);
            $this->retislrmonto->ViewCustomAttributes = "";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // retiva
            $this->retiva->setDbValueDef($rsnew, $this->retiva->CurrentValue, null, $this->retiva->ReadOnly);

            // retislr
            $this->retislr->setDbValueDef($rsnew, $this->retislr->CurrentValue, null, $this->retislr->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // abono
        $this->abono->setDbValueDef($rsnew, $this->abono->CurrentValue, null, strval($this->abono->CurrentValue) == "");

        // monto
        $this->monto->setDbValueDef($rsnew, $this->monto->CurrentValue, null, false);

        // retivamonto
        $this->retivamonto->setDbValueDef($rsnew, $this->retivamonto->CurrentValue, null, false);

        // retiva
        $this->retiva->setDbValueDef($rsnew, $this->retiva->CurrentValue, null, false);

        // retislrmonto
        $this->retislrmonto->setDbValueDef($rsnew, $this->retislrmonto->CurrentValue, null, false);

        // retislr
        $this->retislr->setDbValueDef($rsnew, $this->retislr->CurrentValue, null, false);
