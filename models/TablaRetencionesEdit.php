...
class TablaRetencionesEdit extends TablaRetenciones
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // base_imponible
            $this->base_imponible->setDbValueDef($rsnew, $this->base_imponible->CurrentValue, null, $this->base_imponible->ReadOnly);

            // tarifa
            $this->tarifa->setDbValueDef($rsnew, $this->tarifa->CurrentValue, null, $this->tarifa->ReadOnly);

            // sustraendo
            $this->sustraendo->setDbValueDef($rsnew, $this->sustraendo->CurrentValue, null, $this->sustraendo->ReadOnly);

            // pagos_mayores
            $this->pagos_mayores->setDbValueDef($rsnew, $this->pagos_mayores->CurrentValue, null, $this->pagos_mayores->ReadOnly);
