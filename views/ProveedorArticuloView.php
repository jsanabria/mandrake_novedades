...
loadjs.ready("head", function () {
    ...
    fproveedor_articuloview = currentForm = new ew.Form("fproveedor_articuloview", "view");
    loadjs.done("fproveedor_articuloview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fproveedor_articuloview" id="fproveedor_articuloview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
