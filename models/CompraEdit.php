...
class CompraEdit extends Compra
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // monto_exento
            $this->monto_exento->setDbValueDef($rsnew, $this->monto_exento->CurrentValue, null, $this->monto_exento->ReadOnly);

            // monto_gravado
            $this->monto_gravado->setDbValueDef($rsnew, $this->monto_gravado->CurrentValue, null, $this->monto_gravado->ReadOnly);
