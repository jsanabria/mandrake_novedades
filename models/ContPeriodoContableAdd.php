...
class ContPeriodoContableAdd extends ContPeriodoContable
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cerrado->CurrentValue = null;
        $this->cerrado->OldValue = $this->cerrado->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->fecha_inicio->IsDetailKey) {
            ...
            $this->fecha_inicio->CurrentValue = UnFormatDateTime($this->fecha_inicio->CurrentValue, 7);
        }
        ...
        if (!$this->fecha_fin->IsDetailKey) {
            ...
            $this->fecha_fin->CurrentValue = UnFormatDateTime($this->fecha_fin->CurrentValue, 7);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->fecha_inicio->EditValue = HtmlEncode(FormatDateTime($this->fecha_inicio->CurrentValue, 7));
            ...
            $this->fecha_fin->EditValue = HtmlEncode(FormatDateTime($this->fecha_fin->CurrentValue, 7));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckEuroDate($this->fecha_inicio->FormValue)) {
        ...
        if (!CheckEuroDate($this->fecha_fin->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // fecha_inicio
        $this->fecha_inicio->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_inicio->CurrentValue, 7), null, false);

        // fecha_fin
        $this->fecha_fin->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_fin->CurrentValue, 7), null, false);
