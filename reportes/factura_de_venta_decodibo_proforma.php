...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(8, 4);
		$this->MultiCell(80, 4, utf8_decode($direccion), '0', 'L');
		$this->Cell(8, 4);
		$this->Cell(30, 4,"Teléfono: $telefono1",'0','0','L');
		$this->Ln();
		$this->Cell(8, 4);
		$this->Cell(30, 4,"R.I.F.: $rif_cia",'0','0','L');
		...
		$this->Cell(125, 6);
		$tdoc = ($GLOBALS["documento"]=="FC" ? "Nro. Factura - PROFORMA: " : ($GLOBALS["documento"]=="NC" ? "Nro. Nota de Crédito: " : ($GLOBALS["documento"]=="ND" ? "Nro. Nota de Débito: ":"N/A")));
	...
	function EndReport($id_invoice)
	{
		...
		$this->Cell(90, 4, strtoupper($nota), 0, 0, 'L');
