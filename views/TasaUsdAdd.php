...
loadjs.ready("head", function () {
    ...
    ftasa_usdadd = currentForm = new ew.Form("ftasa_usdadd", "add");
    ...
    // Validate form
    ftasa_usdadd.validate = function () {
    ...
    // Form_CustomValidate
    ftasa_usdadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftasa_usdadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    ftasa_usdadd.lists.moneda = <?= $Page->moneda->toClientList($Page) ?>;
    loadjs.done("ftasa_usdadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftasa_usdadd" id="ftasa_usdadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
