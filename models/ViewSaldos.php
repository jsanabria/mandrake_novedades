...
/**
 * Table class for view_saldos
 */
class ViewSaldos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_saldos';
        $this->TableName = 'view_saldos';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_saldos`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nombre
        $this->nombre = new DbField('view_saldos', 'view_saldos', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 80, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ci_rif
        $this->ci_rif = new DbField('view_saldos', 'view_saldos', 'x_ci_rif', 'ci_rif', '`ci_rif`', '`ci_rif`', 200, 30, -1, false, '`ci_rif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // codigo
        $this->codigo = new DbField('view_saldos', 'view_saldos', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 6, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // saldo
        $this->saldo = new DbField('view_saldos', 'view_saldos', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 131, 36, -1, false, '`saldo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_saldos`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewSaldosList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewSaldosView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewSaldosEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewSaldosAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewSaldosView";
            case Config("API_ADD_ACTION"):
                return "ViewSaldosAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewSaldosEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewSaldosDelete";
            case Config("API_LIST_ACTION"):
                return "ViewSaldosList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewSaldosView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewSaldosView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewSaldosAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewSaldosAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewSaldosEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewSaldosAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewSaldosDelete", $this->getUrlParm());
    }
