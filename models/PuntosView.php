 ...
 * Page class
 */
class PuntosView extends Puntos
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PuntosList"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "PuntosList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
