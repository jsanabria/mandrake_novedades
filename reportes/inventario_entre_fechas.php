...
while($row = mysqli_fetch_array($rs))
{
	...
	$existencia = intval($row["existencia"])+intval($row["devoluciones"]); // $row["existencia"]==0 ? $row["devoluciones"]+$row["entradas"]-$row["salidas"] : $row["devoluciones"]+$row["existencia"];
	// $existencia = $row["existencia"]==0 ? $row["devoluciones"]+$row["entradas"]-$row["salidas"] : $row["devoluciones"]+$row["existencia"];
	...
	$totalcostos += floatval($costo * (intval($row["existencia"])+intval($row["devoluciones"])));
	$unidades += intval($row["existencia"])+intval($row["devoluciones"]); // $row["existencia"]==0 ? $row["devoluciones"]+$row["entradas"]-$row["salidas"] : $row["devoluciones"]+$row["existencia"];
	$items++;
}
