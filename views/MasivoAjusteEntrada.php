...
while (($datos = fgetcsv($archivo, 0, ";")) == true) {
	...
	if($num == 3) {
		...
		$insart->insertar_articulo("TDCAEN", $id, $proveedor, $cod_articulo, $cantidad);
	}
	$codigo = "";
	$nombre = "";
	$precio = 0.00;
...
//Cerramos el archivo
fclose($archivo);
header("EntradasList?tipo=TDCAEN");
    ...
    if($this->existe_articulo) {
      $sql = "INSERT INTO entradas_salidas
          ...
          VALUES 
            ...
            $this->cantidad, '$this->unidad_medida', $this->cantidad_unidad, $this->cantidad, 
