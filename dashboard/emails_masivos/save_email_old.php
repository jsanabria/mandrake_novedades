...
////////////////////////////////////////////////
$sql = "select notificar, notificados_efectivos from sco_notificaciones a where Nnotificaciones = '$id';"; 
$rs = mysql_query($sql); 
$row = mysql_fetch_array($rs);
$notificar = $row["notificar"];
$notificados_efectivos = $row["notificados_efectivos"];
$sql = "SELECT valor2 AS tipo FROM sco_parametro WHERE codigo = '040' AND valor1 = '$notificar';"; 
$rs = mysql_query($sql); 
$row = mysql_fetch_array($rs);
$notificar = $row["tipo"];
////////////////////////////////////////////////
...
$sql = "UPDATE sco_notificaciones SET asunto = '$asunto', notificacion = '$notificacion', adjunto = '$adjunto_name' WHERE Nnotificaciones = '$id'";
