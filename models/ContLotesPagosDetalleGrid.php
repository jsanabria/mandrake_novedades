...
class ContLotesPagosDetalleGrid extends ContLotesPagosDetalle
{
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_proveedor") && $CurrentForm->hasValue("o_proveedor") && $this->proveedor->CurrentValue != $this->proveedor->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_fecha") && $CurrentForm->hasValue("o_fecha") && $this->fecha->CurrentValue != $this->fecha->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tipodoc") && $CurrentForm->hasValue("o_tipodoc") && $this->tipodoc->CurrentValue != $this->tipodoc->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_nro_documento") && $CurrentForm->hasValue("o_nro_documento") && $this->nro_documento->CurrentValue != $this->nro_documento->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_monto_a_pagar") && $CurrentForm->hasValue("o_monto_a_pagar") && $this->monto_a_pagar->CurrentValue != $this->monto_a_pagar->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_monto_pagado") && $CurrentForm->hasValue("o_monto_pagado") && $this->monto_pagado->CurrentValue != $this->monto_pagado->OldValue) {
            return false;
        }
    ...
    {
        $this->proveedor->clearErrorMessage();
        $this->fecha->clearErrorMessage();
        $this->tipodoc->clearErrorMessage();
        $this->nro_documento->clearErrorMessage();
        $this->monto_a_pagar->clearErrorMessage();
        $this->monto_pagado->clearErrorMessage();
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->monto_a_pagar->EditValue) != "" && is_numeric($this->monto_a_pagar->EditValue)) {
                ...
                $this->monto_a_pagar->OldValue = $this->monto_a_pagar->EditValue;
            }
            ...
            if (strval($this->monto_pagado->EditValue) != "" && is_numeric($this->monto_pagado->EditValue)) {
                ...
                $this->monto_pagado->OldValue = $this->monto_pagado->EditValue;
            }
