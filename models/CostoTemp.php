...
class CostoTemp extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // codigo
        $this->codigo = new DbField('costo_temp', 'costo_temp', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre
        $this->nombre = new DbField('costo_temp', 'costo_temp', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 150, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // costo
        $this->costo = new DbField('costo_temp', 'costo_temp', 'x_costo', 'costo', '`costo`', '`costo`', 131, 13, -1, false, '`costo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "CostoTempView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CostoTempEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CostoTempAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CostoTempView";
            case Config("API_ADD_ACTION"):
                return "CostoTempAdd";
            case Config("API_EDIT_ACTION"):
                return "CostoTempEdit";
            case Config("API_DELETE_ACTION"):
                return "CostoTempDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CostoTempView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CostoTempView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CostoTempAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CostoTempAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("CostoTempEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CostoTempAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CostoTempDelete", $this->getUrlParm());
    }
