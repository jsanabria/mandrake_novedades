...
class AsesorClienteAdd extends AsesorCliente
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        $masterFilter = $this->sqlMasterFilter_asesor();
        if ($this->asesor->getSessionValue() != "") {
        $masterFilter = str_replace("@id@", AdjustSql($this->asesor->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
            $rsmaster = Container("asesor")->loadRs($masterFilter)->fetch();
