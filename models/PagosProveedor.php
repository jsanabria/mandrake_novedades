...
class PagosProveedor extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // proveedor
        $this->proveedor = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_proveedor', 'proveedor', '`proveedor`', '`proveedor`', 19, 10, -1, false, '`proveedor`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // pivote
        $this->pivote = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_pivote', 'pivote', '`pivote`', '`pivote`', 200, 1, -1, false, '`pivote`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tipo_pago
        $this->tipo_pago = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_tipo_pago', 'tipo_pago', '`tipo_pago`', '`tipo_pago`', 200, 2, -1, false, '`tipo_pago`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // banco
        $this->banco = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_banco', 'banco', '`banco`', '`banco`', 19, 10, -1, false, '`banco`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // fecha
        $this->fecha = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_fecha', 'fecha', '`fecha`', CastDateFieldForLike("`fecha`", 7, "DB"), 133, 10, 7, false, '`fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // referencia
        $this->referencia = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_referencia', 'referencia', '`referencia`', '`referencia`', 200, 50, -1, false, '`referencia`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // moneda
        $this->moneda = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_moneda', 'moneda', '`moneda`', '`moneda`', 200, 6, -1, false, '`moneda`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // monto_dado
        $this->monto_dado = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_monto_dado', 'monto_dado', '`monto_dado`', '`monto_dado`', 131, 14, -1, false, '`monto_dado`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->monto_dado->Required = true; // Required field
        $this->monto_dado->Sortable = true; // Allow sort
        $this->monto_dado->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->monto_dado->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_dado->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->monto_dado->Param, "CustomMsg");
        $this->Fields['monto_dado'] = &$this->monto_dado;

        // monto
        $this->monto = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_monto', 'monto', '`monto`', '`monto`', 131, 14, -1, false, '`monto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nota
        $this->nota = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_nota', 'nota', '`nota`', '`nota`', 200, 255, -1, false, '`nota`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // fecha_registro
        $this->fecha_registro = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_fecha_registro', 'fecha_registro', '`fecha_registro`', CastDateFieldForLike("`fecha_registro`", 7, "DB"), 133, 10, 7, false, '`fecha_registro`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // username
        $this->_username = new DbField('pagos_proveedor', 'pagos_proveedor', 'x__username', 'username', '`username`', '`username`', 200, 30, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // comprobante
        $this->comprobante = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_comprobante', 'comprobante', '`comprobante`', '`comprobante`', 200, 1, -1, false, '`comprobante`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // cont_lotes
        $this->cont_lotes = new DbField('pagos_proveedor', 'pagos_proveedor', 'x_cont_lotes', 'cont_lotes', '`cont_lotes`', '`cont_lotes`', 3, 11, -1, false, '`cont_lotes`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->cont_lotes->Sortable = true; // Allow sort
        $this->cont_lotes->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->cont_lotes->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->cont_lotes->Param, "CustomMsg");
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("pagos_proveedor_factura")->loadRs("`pagos_proveedor` = " . QuotedValue($rs['id'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    {
        global $Language;
        if ($pageName == "PagosProveedorView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PagosProveedorEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PagosProveedorAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PagosProveedorView";
            case Config("API_ADD_ACTION"):
                return "PagosProveedorAdd";
            case Config("API_EDIT_ACTION"):
                return "PagosProveedorEdit";
            case Config("API_DELETE_ACTION"):
                return "PagosProveedorDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosProveedorView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PagosProveedorView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PagosProveedorAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosProveedorEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PagosProveedorEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosProveedorAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PagosProveedorAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PagosProveedorDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // cont_lotes
        $this->cont_lotes->LinkCustomAttributes = "";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->monto_dado->EditValue) != "" && is_numeric($this->monto_dado->EditValue)) {
            $this->monto_dado->EditValue = FormatNumber($this->monto_dado->EditValue, -2, -1, -2, -1);
        }
        ...
        // cont_lotes
        $this->cont_lotes->EditAttrs["class"] = "form-control";
        $this->cont_lotes->EditCustomAttributes = "";
    ...
    public function rowUpdating($rsold, &$rsnew) {
    	...
    	if($rsold["comprobante"] != "") {
    		$this->CancelMessage = "Este pago est&aacute; contabilizado; no se puede modificar.";
    		return FALSE;
    	}
