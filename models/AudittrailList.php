...
class AudittrailList extends Audittrail
{
    ...
    protected function loadSearchValues()
    {
        ...
        // script
        if (!$this->isAddOrEdit() && $this->script->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // user
        if (!$this->isAddOrEdit() && $this->user->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // table
        if (!$this->isAddOrEdit() && $this->_table->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // field
        if (!$this->isAddOrEdit() && $this->field->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // keyvalue
        if (!$this->isAddOrEdit() && $this->keyvalue->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // oldvalue
        if (!$this->isAddOrEdit() && $this->oldvalue->AdvancedSearch->get()) {
            $hasValue = true;
