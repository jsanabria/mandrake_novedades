...
class ViewLotes extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_lotes', 'view_lotes', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // articulo
        $this->articulo = new DbField('view_lotes', 'view_lotes', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // lote
        $this->lote = new DbField('view_lotes', 'view_lotes', 'x_lote', 'lote', '`lote`', '`lote`', 200, 20, -1, false, '`lote`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fecha_vencimiento
        $this->fecha_vencimiento = new DbField('view_lotes', 'view_lotes', 'x_fecha_vencimiento', 'fecha_vencimiento', '`fecha_vencimiento`', '`fecha_vencimiento`', 200, 10, -1, false, '`fecha_vencimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad
        $this->cantidad = new DbField('view_lotes', 'view_lotes', 'x_cantidad', 'cantidad', '`cantidad`', '`cantidad`', 131, 33, -1, false, '`cantidad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ViewLotesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLotesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLotesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLotesView";
            case Config("API_ADD_ACTION"):
                return "ViewLotesAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLotesEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLotesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLotesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLotesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLotesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewLotesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewLotesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLotesDelete", $this->getUrlParm());
    }
