...
loadjs.ready("head", function () {
    ...
    faudittrailadd.addFields([
        ["datetime", [fields.datetime.visible && fields.datetime.required ? ew.Validators.required(fields.datetime.caption) : null, ew.Validators.datetime(11)], fields.datetime.isInvalid],
...
<input type="<?= $Page->datetime->getInputTextType() ?>" data-table="audittrail" data-field="x_datetime" data-format="11" name="x_datetime" id="x_datetime" placeholder="<?= HtmlEncode($Page->datetime->getPlaceHolder()) ?>" value="<?= $Page->datetime->EditValue ?>"<?= $Page->datetime->editAttributes() ?> aria-describedby="x_datetime_help">
...
loadjs.ready(["faudittrailadd", "datetimepicker"], function() {
    ew.createDateTimePicker("faudittrailadd", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
