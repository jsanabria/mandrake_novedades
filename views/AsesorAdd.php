...
loadjs.ready("head", function () {
    ...
    fasesoradd = currentForm = new ew.Form("fasesoradd", "add");
    ...
    // Form_CustomValidate
    fasesoradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fasesoradd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fasesoradd.lists.ciudad = <?= $Page->ciudad->toClientList($Page) ?>;
    fasesoradd.lists.activo = <?= $Page->activo->toClientList($Page) ?>;
    loadjs.done("fasesoradd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fasesoradd" id="fasesoradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fasesoradd"], function() {
    fasesoradd.createAutoSuggest(Object.assign({"id":"x_ciudad","forceSelect":true}, ew.vars.tables.asesor.fields.ciudad.autoSuggestOptions));
});
</script>
