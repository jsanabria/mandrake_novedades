...
loadjs.ready("head", function () {
    ...
    ftemp_consignacionedit = currentForm = new ew.Form("ftemp_consignacionedit", "edit");
    ...
    ftemp_consignacionedit.addFields([
    ...
    // Validate form
    ftemp_consignacionedit.validate = function () {
    ...
    // Form_CustomValidate
    ftemp_consignacionedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftemp_consignacionedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftemp_consignacionedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="ftemp_consignacionedit" id="ftemp_consignacionedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
