 ...
 * Page class
 */
class CobrosClienteEncabezadoAdd extends CobrosClienteEncabezado
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteEncabezadoAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("CobrosClienteEncabezadoList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "CobrosClienteEncabezadoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "CobrosClienteEncabezadoView") {
