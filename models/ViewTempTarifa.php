...
class ViewTempTarifa extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // codigo
        $this->codigo = new DbField('view_temp_tarifa', 'view_temp_tarifa', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, 50, -1, false, '`codigo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nombre
        $this->nombre = new DbField('view_temp_tarifa', 'view_temp_tarifa', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, 150, -1, false, '`nombre`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // precio
        $this->precio = new DbField('view_temp_tarifa', 'view_temp_tarifa', 'x_precio', 'precio', '`precio`', '`precio`', 131, 13, -1, false, '`precio`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ViewTempTarifaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewTempTarifaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewTempTarifaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTempTarifaView";
            case Config("API_ADD_ACTION"):
                return "ViewTempTarifaAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewTempTarifaEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewTempTarifaDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTempTarifaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewTempTarifaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewTempTarifaAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewTempTarifaDelete", $this->getUrlParm());
    }
