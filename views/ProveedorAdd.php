...
loadjs.ready("head", function () {
    ...
    fproveedoradd.lists.ciudad = <?= $Page->ciudad->toClientList($Page) ?>;
...
loadjs.ready(["fproveedoradd"], function() {
    fproveedoradd.createAutoSuggest(Object.assign({"id":"x_ciudad","forceSelect":true}, ew.vars.tables.proveedor.fields.ciudad.autoSuggestOptions));
});
</script>
