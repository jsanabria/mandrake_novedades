...
loadjs.ready("head", function () {
    ...
    fcont_asientoedit = currentForm = new ew.Form("fcont_asientoedit", "edit");
    ...
    // Validate form
    fcont_asientoedit.validate = function () {
    ...
    // Form_CustomValidate
    fcont_asientoedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcont_asientoedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fcont_asientoedit.lists.cuenta = <?= $Page->cuenta->toClientList($Page) ?>;
    loadjs.done("fcont_asientoedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fcont_asientoedit" id="fcont_asientoedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
