...
class CobrosClienteView extends CobrosCliente
{
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            $returnUrl = "CobrosClienteList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("CobrosClienteDetalleList?" . Config("TABLE_SHOW_MASTER") . "=cobros_cliente&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    public function pageLoad()
    {
    	...
    	/*
    	$sql = ";";
    	$caption = ExecuteScalar($sql);
        $this->setTableCaption($caption);
        */
    }
