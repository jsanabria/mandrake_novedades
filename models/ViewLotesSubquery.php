...
class ViewLotesSubquery extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_lotes_subquery', 'view_lotes_subquery', 'x_id', 'id', '`id`', '`id`', 21, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cantidad_movimiento
        $this->cantidad_movimiento = new DbField('view_lotes_subquery', 'view_lotes_subquery', 'x_cantidad_movimiento', 'cantidad_movimiento', '`cantidad_movimiento`', '`cantidad_movimiento`', 131, 32, -1, false, '`cantidad_movimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        global $Language;
        if ($pageName == "ViewLotesSubqueryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLotesSubqueryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLotesSubqueryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLotesSubqueryView";
            case Config("API_ADD_ACTION"):
                return "ViewLotesSubqueryAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLotesSubqueryEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLotesSubqueryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLotesSubqueryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLotesSubqueryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLotesSubqueryAdd?" . $this->getUrlParm($parm);
        } else {
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLotesSubqueryDelete", $this->getUrlParm());
    }
