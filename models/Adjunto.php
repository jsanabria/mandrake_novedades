...
class Adjunto extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('adjunto', 'adjunto', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // articulo
        $this->articulo = new DbField('adjunto', 'adjunto', 'x_articulo', 'articulo', '`articulo`', '`articulo`', 19, 10, -1, false, '`articulo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cliente
        $this->cliente = new DbField('adjunto', 'adjunto', 'x_cliente', 'cliente', '`cliente`', '`cliente`', 19, 10, -1, false, '`cliente`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // proveedor
        $this->proveedor = new DbField('adjunto', 'adjunto', 'x_proveedor', 'proveedor', '`proveedor`', '`proveedor`', 19, 10, -1, false, '`proveedor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // foto
        $this->foto = new DbField('adjunto', 'adjunto', 'x_foto', 'foto', '`foto`', '`foto`', 200, 250, -1, true, '`foto`', false, false, false, 'IMAGE', 'FILE');
        ...
        // nota
        $this->nota = new DbField('adjunto', 'adjunto', 'x_nota', 'nota', '`nota`', '`nota`', 200, 250, -1, false, '`nota`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "articulo") {
            if ($this->articulo->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->articulo->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
        if ($this->getCurrentMasterTable() == "cliente") {
            if ($this->cliente->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->cliente->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "articulo") {
            if ($this->articulo->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`articulo`", $this->articulo->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
        if ($this->getCurrentMasterTable() == "cliente") {
            if ($this->cliente->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`cliente`", $this->cliente->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_articulo()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_articulo()
    {
        return "`articulo`=@articulo@";
    }

    // Master filter
    public function sqlMasterFilter_cliente()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_cliente()
    {
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AdjuntoEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AdjuntoAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AdjuntoView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AdjuntoView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AdjuntoAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AdjuntoAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("AdjuntoEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdjuntoAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AdjuntoDelete", $this->getUrlParm());
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "articulo" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->articulo->CurrentValue ?? $this->articulo->getSessionValue());
        }
        if ($this->getCurrentMasterTable() == "cliente" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->cliente->CurrentValue ?? $this->cliente->getSessionValue());
        }
