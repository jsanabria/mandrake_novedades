...
class PagosProveedorEdit extends PagosProveedor
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // banco
            $this->banco->setDbValueDef($rsnew, $this->banco->CurrentValue, 0, $this->banco->ReadOnly);
            ...
            // monto_dado
            $this->monto_dado->setDbValueDef($rsnew, $this->monto_dado->CurrentValue, null, $this->monto_dado->ReadOnly);
